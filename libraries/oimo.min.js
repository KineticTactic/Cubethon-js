...
!(function (t, i) {
        ...
        void 0 === Object.assign &&
            (Object.assign = function (t) {
                ...
                for (var i = Object(t), s = 1; s < arguments.length; s++) {
                    var h = arguments[s];
                    if (null != h) for (var e in h) Object.prototype.hasOwnProperty.call(h, e) && (i[e] = h[e]);
                }
                return i;
            });
    var s,
        ...
        g = {
            ...
            generateUUID:
                ((h = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("")),
                (e = new Array(36)),
                (a = 0),
                function () {
                    for (var t = 0; t < 36; t++)
                        8 === t || 13 === t || 18 === t || 23 === t
                            ...
                            : 14 === t
                            ? (e[t] = "4")
                            : (a <= 2 && (a = (33554432 + 16777216 * Math.random()) | 0),
                              (s = 15 & a),
                              (a >>= 4),
                              (e[t] = h[19 === t ? (3 & s) | 8 : s]));
                    return e.join("");
    ...
    function P(t, i, s, h, e, a, o, n, r) {
        (this.elements = [1, 0, 0, 0, 1, 0, 0, 0, 1]),
            arguments.length > 0 && console.error("OIMO.Mat33: the constructor no longer reads arguments. use .set() instead.");
    }
    ...
    Object.assign(V.prototype, {
        ...
        show: function () {
            return [
                ...
                "broadphase &nbsp;" + g.fix(this.broadPhaseTime) + " | " + g.fix(this.MaxBroadPhaseTime) + "<br>",
                "narrowphase " + g.fix(this.narrowPhaseTime) + " | " + g.fix(this.MaxNarrowPhaseTime) + "<br>",
                "solving &nbsp;&nbsp;&nbsp;&nbsp;" + g.fix(this.solvingTime) + " | " + g.fix(this.MaxSolvingTime) + "<br>",
                "total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + g.fix(this.totalTime) + " | " + g.fix(this.MaxTotalTime) + "<br>",
                "updating &nbsp;&nbsp;&nbsp;" + g.fix(this.updateTime) + " | " + g.fix(this.MaxUpdateTime) + "<br>",
            ].join("\n");
        },
        toArray: function () {
            return (
        ...
        Object.assign(L.prototype, {
            ...
            applyMatrix3: function (t, i) {
                ...
                return (
                    i
                        ? ((this.x = a[0] * s + a[1] * h + a[2] * e),
                          (this.y = a[3] * s + a[4] * h + a[5] * e),
                          (this.z = a[6] * s + a[7] * h + a[8] * e))
                        : ((this.x = a[0] * s + a[3] * h + a[6] * e),
                          (this.y = a[1] * s + a[4] * h + a[7] * e),
                          (this.z = a[2] * s + a[5] * h + a[8] * e)),
                    this
                );
            },
            applyQuaternion: function (t) {
                var i = this.x,
                    ...
                    m = -e * i - a * s - o * h;
                return (
                    (this.x = r * n + m * -e + l * -o - c * -a),
                    (this.y = l * n + m * -a + c * -e - r * -o),
                    (this.z = c * n + m * -o + r * -a - l * -e),
                    this
                );
            },
            testZero: function () {
        ...
        Object.assign(S.prototype, {
            ...
            addTime: function (t, i) {
                ...
                return (
                    (i *= 0.5),
                    (this.x += i * (s * a + h * r - e * n)),
                    (this.y += i * (h * a + e * o - s * r)),
                    (this.z += i * (e * a + s * n - h * o)),
                    (this.w += i * (-s * o - h * n - e * r)),
                    this.normalize(),
                    this
                );
            },
            ...
            multiplyQuaternions: function (t, i) {
                var s = t.x,
                    ...
                    l = i.w;
                return (
                    (this.x = s * l + a * o + h * r - e * n),
                    (this.y = h * l + a * n + e * o - s * r),
                    (this.z = e * l + a * r + s * n - h * o),
                    (this.w = a * l - s * o - h * n - e * r),
                    this
                );
            },
            setFromUnitVectors: function (t, i) {
                var s = new L(),
                    h = t.dot(i) + 1;
                return (
                    h < g.EPS2 ? ((h = 0), g.abs(t.x) > g.abs(t.z) ? s.set(-t.y, t.x, 0) : s.set(0, -t.z, t.y)) : s.crossVectors(t, i),
                    (this._x = s.x),
                    (this._y = s.y),
                    (this._z = s.z),
                    (this._w = h),
            ...
            arc: function (t, i) {
                ...
                var l = h * n - e * o,
                    c = e * a - s * n,
                    m = s * o - h * a;
                return (this.w = g.sqrt(0.5 * (1 + r))), (r = 0.5 / this.w), (this.x = l * r), (this.y = c * r), (this.z = m * r), this;
            },
            normalize: function () {
                var t = this.length();
                return (
            ...
            setFromMat33: function (t) {
                ...
                if (s > 0)
                    ...
                    var a = (e + 1) % 3,
                        o = (e + 2) % 3;
                    (i = g.sqrt(t[3 * e + e] - t[3 * a + a] - t[3 * o + o] + 1)),
                        (h[e] = 0.5 * fRoot),
                        (i = 0.5 / fRoot),
                        (this.w = (t[3 * a + o] - t[3 * o + a]) * i),
                        (h[a] = (t[3 * a + e] + t[3 * e + a]) * i),
                        (h[o] = (t[3 * o + e] + t[3 * e + o]) * i),
                        (this.x = h[1]),
                        (this.y = h[2]),
                        (this.z = h[3]);
                }
    ...
    function j(t) {
        (this.type = p),
            ...
            (this.position = new L()),
            (this.rotation = new P()),
            (this.relativePosition = new L().copy(t.relativePosition)),
            (this.relativeRotation = new P().copy(t.relativeRotation)),
            (this.aabb = new T()),
    ...
    function C(t, i, s, h) {
        j.call(this, t),
            ...
            (this.height = s),
            (this.depth = h),
            (this.halfWidth = 0.5 * i),
            (this.halfHeight = 0.5 * s),
            (this.halfDepth = 0.5 * h),
    ...
    function D(t, i, s) {
        j.call(this, t),
            ...
            (this.height = s),
            (this.halfHeight = 0.5 * s),
            (this.normalDirection = new L()),
            (this.halfDirection = new L());
    }
    function E(t, i) {
    ...
    function F() {
        (this.relativePosition = new L()),
            (this.relativeRotation = new P()),
            (this.friction = 0.2),
    ...
    function _(t) {
        U.call(this),
            ...
            (this.body1 = t.body1),
            (this.body2 = t.body2),
            (this.localAnchorPoint1 = new L().copy(t.localAnchorPoint1)),
            (this.localAnchorPoint2 = new L().copy(t.localAnchorPoint2)),
            (this.relativeAnchorPoint1 = new L()),
            (this.relativeAnchorPoint2 = new L()),
            (this.anchorPoint1 = new L()),
            (this.anchorPoint2 = new L()),
            (this.allowCollision = t.allowCollision),
            (this.b1Link = new R(this)),
            (this.b2Link = new R(this));
    }
    function J(t) {
        (this.m1 = NaN),
            (this.m2 = NaN),
    ...
    function H(t, i, s) {
        ...
        (this.localAngle1 = new L().tangent(this.localAxis1).normalize()),
            (this.localAngle2 = this.localAngle1.clone().applyMatrix3(h, !0)),
            (this.ax1 = new L()),
            (this.ax2 = new L()),
            (this.an1 = new L()),
            (this.an2 = new L()),
            ...
            (this.tan = new L()),
            (this.bin = new L()),
            (this.limitMotor = new q(this.nor, !1)),
            (this.limitMotor.lowerLimit = i),
            (this.limitMotor.upperLimit = s),
            (this.lc = new J(this)),
            (this.r3 = new W(this, this.limitMotor, new q(this.tan, !0), new q(this.bin, !0)));
    }
    function Q(t) {
    ...
    function Y(t, i, s) {
        _.call(this, t),
            (this.type = v),
            (this.nor = new L()),
            (this.limitMotor = new q(this.nor, !0)),
            (this.limitMotor.lowerLimit = i),
            (this.limitMotor.upperLimit = s),
            (this.t = new X(this, this.limitMotor));
    }
    function Z(t, i) {
        (this.joint = t),
            (this.targetOrientation = new S().invert(i)),
            (this.relativeOrientation = new S()),
            (this.ii1 = null),
            (this.ii2 = null),
            (this.dd = null),
            (this.vel = new L()),
    ...
    function G(t, i, s) {
        _.call(this, t),
            ...
            (this.tan = new L()),
            (this.bin = new L()),
            (this.ac = new Z(this, new S().setFromUnitVectors(this.localAxis1, this.localAxis2))),
            (this.limitMotor = new q(this.nor, !0)),
            (this.limitMotor.lowerLimit = i),
            (this.limitMotor.upperLimit = s),
            (this.t3 = new K(this, this.limitMotor, new q(this.tan, !0), new q(this.bin, !0)));
    }
    function $(t, i, s) {
        _.call(this, t),
            (this.type = w),
        ...
        (this.localAngle1 = new L().tangent(this.localAxis1).normalize()),
            ...
            (this.tan = new L()),
            (this.bin = new L()),
            (this.rotationalLimitMotor = new q(this.nor, !1)),
            (this.r3 = new W(this, this.rotationalLimitMotor, new q(this.tan, !0), new q(this.bin, !0))),
            (this.translationalLimitMotor = new q(this.nor, !0)),
            (this.translationalLimitMotor.lowerLimit = i),
            (this.translationalLimitMotor.upperLimit = s),
            (this.t3 = new K(this, this.translationalLimitMotor, new q(this.tan, !0), new q(this.bin, !0)));
    }
    function tt(t) {
        _.call(this, t),
            (this.type = k),
            (this.localAxis1 = t.localAxis1.clone().normalize()),
            (this.localAxis2 = t.localAxis2.clone().normalize()),
            (this.localAngle1 = new L()),
            (this.localAngle2 = new L());
        var i = g.dotVectors(this.localAxis1, this.localAxis2);
        if (i > -1 && i < 1)
            this.localAngle1
                .set(
                    this.localAxis2.x - i * this.localAxis1.x,
                    this.localAxis2.y - i * this.localAxis1.y,
                    this.localAxis2.z - i * this.localAxis1.z
                )
                .normalize(),
                this.localAngle2
                    .set(
                        this.localAxis1.x - i * this.localAxis2.x,
                        this.localAxis1.y - i * this.localAxis2.y,
                        this.localAxis1.z - i * this.localAxis2.z
                    )
                    .normalize();
        else {
        ...
        (this.ax1 = new L()),
            ...
            (this.tan = new L()),
            (this.bin = new L()),
            (this.translationalLimitMotor = new q(this.tan, !0)),
            (this.translationalLimitMotor.frequency = 8),
            (this.translationalLimitMotor.dampingRatio = 1),
            (this.rotationalLimitMotor1 = new q(this.tan, !1)),
            (this.rotationalLimitMotor2 = new q(this.bin, !1)),
            (this.t3 = new K(this, new q(this.nor, !0), this.translationalLimitMotor, new q(this.bin, !0))),
            (this.t3.weight = 1),
            (this.r3 = new W(this, new q(this.nor, !0), this.rotationalLimitMotor1, this.rotationalLimitMotor2));
    }
    function it() {
        (this.scale = 1),
            (this.invScale = 1),
            (this.body1 = null),
            (this.body2 = null),
            (this.localAnchorPoint1 = new L()),
            (this.localAnchorPoint2 = new L()),
            (this.localAxis1 = new L()),
            (this.localAxis2 = new L()),
    ...
    function at() {
        (this.warmStarted = !1),
            (this.position = new L()),
            (this.localPoint1 = new L()),
            (this.localPoint2 = new L()),
            (this.normal = new L()),
            (this.tangent = new L()),
            (this.binormal = new L()),
    ...
    function rt(t) {
        U.call(this),
            ...
            (this.cs = new nt()),
            (this.cs.next = new nt()),
            (this.cs.next.next = new nt()),
            (this.cs.next.next.next = new nt());
    }
    function lt() {
        (this.shape1 = null),
            (this.shape2 = null),
            ...
            (this.close = !1),
            (this.dist = g.INF),
            (this.b1Link = new ht(this)),
            (this.b2Link = new ht(this)),
            (this.s1Link = new ht(this)),
            (this.s2Link = new ht(this)),
            (this.manifold = new ot()),
            (this.buffer = [new et(), new et(), new et(), new et()]),
            (this.points = this.manifold.points),
            (this.constraint = new rt(this.manifold));
    }
    function ct(t, i) {
        (this.position = t || new L()),
            (this.orientation = i || new S()),
            (this.scale = 1),
            (this.invScale = 1),
            (this.mesh = null),
            (this.id = NaN),
            ...
            (this.next = null),
            (this.type = m),
            (this.massInfo = new st()),
            (this.newPosition = new L()),
            (this.controlPos = !1),
            (this.newOrientation = new S()),
            (this.newRotation = new L()),
            (this.currentRotation = new L()),
            (this.controlRot = !1),
            (this.controlRotInTime = !1),
            (this.quaternion = new S()),
            (this.pos = new L()),
            (this.linearVelocity = new L()),
            (this.angularVelocity = new L()),
            (this.parent = null),
            (this.contactLink = null),
            (this.numContacts = 0),
            (this.shapes = null),
            ...
            (this.jointLink = null),
            (this.numJoints = 0),
            (this.sleepPosition = new L()),
            (this.sleepOrientation = new S()),
            (this.isStatic = !1),
            (this.isDynamic = !1),
            (this.isKinematic = !1),
            (this.rotation = new P()),
    ...
    Object.assign(j.prototype, {
        ...
        (C.prototype = Object.assign(Object.create(j.prototype), {
            ...
            calculateMassInfo: function (t) {
                ...
                (t.mass = i),
                    t.inertia.set(
                        i * (this.height * this.height + this.depth * this.depth) * (1 / 12),
                        0,
                        0,
                        0,
                        i * (this.width * this.width + this.depth * this.depth) * (1 / 12),
                        0,
                        0,
                        0,
                        i * (this.width * this.width + this.height * this.height) * (1 / 12)
                    );
            },
            updateProxy: function () {
                ...
                (i[0] = t[0]),
                    ...
                    (i[7] = t[5]),
                    (i[8] = t[8]),
                    (i[9] = t[0] * this.halfWidth),
                    (i[10] = t[3] * this.halfWidth),
                    (i[11] = t[6] * this.halfWidth),
                    (i[12] = t[1] * this.halfHeight),
                    (i[13] = t[4] * this.halfHeight),
                    (i[14] = t[7] * this.halfHeight),
                    (i[15] = t[2] * this.halfDepth),
                    (i[16] = t[5] * this.halfDepth),
                    (i[17] = t[8] * this.halfDepth);
                var s = i[9],
                    h = i[10],
                    e = i[11],
                    a = i[12],
                ...
                var x = i[9] < 0 ? -i[9] : i[9],
                    d = i[10] < 0 ? -i[10] : i[10],
                    f = i[11] < 0 ? -i[11] : i[11];
                (x = i[12] < 0 ? x - i[12] : x + i[12]),
                    (d = i[13] < 0 ? d - i[13] : d + i[13]),
                    (f = i[14] < 0 ? f - i[14] : f + i[14]),
                    (x = i[15] < 0 ? x - i[15] : x + i[15]),
                    (d = i[16] < 0 ? d - i[16] : d + i[16]),
                    (f = i[17] < 0 ? f - i[17] : f + i[17]);
                var b = 0.005;
                this.aabb.set(
                    this.position.x - x - b,
                    this.position.x + x + b,
        ...
        (O.prototype = Object.assign(Object.create(j.prototype), {
            ...
            calculateMassInfo: function (t) {
                ...
                t.mass = i;
                var s = i * this.radius * this.radius * 0.4;
        ...
        (D.prototype = Object.assign(Object.create(j.prototype), {
            ...
            calculateMassInfo: function (t) {
                var i = this.radius * this.radius,
                    ...
                    h = (0.25 * i + 0.0833 * this.height * this.height) * s,
                    e = 0.5 * i;
            ...
            updateProxy: function () {
                ...
                (e = m[1] * m[1]),
                    (a = m[4] * m[4]),
                    (o = m[7] * m[7]),
                    this.normalDirection.set(m[1], m[4], m[7]),
                    this.halfDirection.scale(this.normalDirection, this.halfHeight),
                    (i = 1 - e),
                    (t = g.sqrt(i * i + e * a + e * o)) > 0 && (t = this.radius / t),
                    (i *= t),
                    (s = 1 - a),
                    (t = g.sqrt(a * e + s * s + a * o)) > 0 && (t = this.radius / t),
                    (s *= t),
                    (h = 1 - o),
                    (t = g.sqrt(o * e + o * a + h * h)) > 0 && (t = this.radius / t),
                    (h *= t),
                    (n = this.halfDirection.x < 0 ? -this.halfDirection.x : this.halfDirection.x),
                    (r = this.halfDirection.y < 0 ? -this.halfDirection.y : this.halfDirection.y),
                    (l = this.halfDirection.z < 0 ? -this.halfDirection.z : this.halfDirection.z),
                    (n = i < 0 ? n - i : n + i),
                    (r = s < 0 ? r - s : r + s),
                    (l = h < 0 ? l - h : l + h),
                    (c = 0.005),
        ...
        (E.prototype = Object.assign(Object.create(j.prototype), {
            ...
            updateProxy: function () {
                var t = 0.005,
                    ...
                    h = this.normal;
                this.aabb.set(
                    -1 === h.x ? this.position.x - t : i,
                    1 === h.x ? this.position.x + t : s,
                    -1 === h.y ? this.position.y - t : i,
                    1 === h.y ? this.position.y + t : s,
                    -1 === h.z ? this.position.z - t : i,
                    1 === h.z ? this.position.z + t : s
                ),
                    null != this.proxy && this.proxy.update();
            },
        })),
        ...
        (_.prototype = Object.assign(Object.create(U.prototype), {
            ...
            detach: function (t) {
                if (t)
                    ...
                    null != i && (i.next = s),
                        null != s && (s.prev = i),
                        this.body1.jointLink == this.b1Link && (this.body1.jointLink = s),
                        ...
                        null != i && (i.next = s),
                        null != s && (s.prev = i),
                        this.body2.jointLink == this.b2Link && (this.body2.jointLink = s),
        ...
        Object.assign(J.prototype, {
            ...
            preSolve: function (t, i) {
                ...
                var s = this.ii1.elements,
                    h = this.ii2.elements;
                (this.ax1x = this.r1z * s[1] + -this.r1y * s[2]),
                    (this.ax1y = this.r1z * s[4] + -this.r1y * s[5]),
                    (this.ax1z = this.r1z * s[7] + -this.r1y * s[8]),
                    (this.ay1x = -this.r1z * s[0] + this.r1x * s[2]),
                    (this.ay1y = -this.r1z * s[3] + this.r1x * s[5]),
                    (this.ay1z = -this.r1z * s[6] + this.r1x * s[8]),
                    (this.az1x = this.r1y * s[0] + -this.r1x * s[1]),
                    (this.az1y = this.r1y * s[3] + -this.r1x * s[4]),
                    (this.az1z = this.r1y * s[6] + -this.r1x * s[7]),
                    (this.ax2x = this.r2z * h[1] + -this.r2y * h[2]),
                    (this.ax2y = this.r2z * h[4] + -this.r2y * h[5]),
                    (this.ax2z = this.r2z * h[7] + -this.r2y * h[8]),
                    (this.ay2x = -this.r2z * h[0] + this.r2x * h[2]),
                    (this.ay2y = -this.r2z * h[3] + this.r2x * h[5]),
                    (this.ay2z = -this.r2z * h[6] + this.r2x * h[8]),
                    (this.az2x = this.r2y * h[0] + -this.r2x * h[1]),
                    (this.az2y = this.r2y * h[3] + -this.r2x * h[4]),
                    (this.az2z = this.r2y * h[6] + -this.r2x * h[7]);
                var e = this.m1 + this.m2,
                    a = new P().set(e, 0, 0, 0, e, 0, 0, 0, e).elements;
                (a[0] += s[4] * this.r1z * this.r1z - (s[7] + s[5]) * this.r1y * this.r1z + s[8] * this.r1y * this.r1y),
                    (a[1] += (s[6] * this.r1y + s[5] * this.r1x) * this.r1z - s[3] * this.r1z * this.r1z - s[8] * this.r1x * this.r1y),
                    (a[2] += (s[3] * this.r1y - s[4] * this.r1x) * this.r1z - s[6] * this.r1y * this.r1y + s[7] * this.r1x * this.r1y),
                    (a[3] += (s[2] * this.r1y + s[7] * this.r1x) * this.r1z - s[1] * this.r1z * this.r1z - s[8] * this.r1x * this.r1y),
                    (a[4] += s[0] * this.r1z * this.r1z - (s[6] + s[2]) * this.r1x * this.r1z + s[8] * this.r1x * this.r1x),
                    (a[5] += (s[1] * this.r1x - s[0] * this.r1y) * this.r1z - s[7] * this.r1x * this.r1x + s[6] * this.r1x * this.r1y),
                    (a[6] += (s[1] * this.r1y - s[4] * this.r1x) * this.r1z - s[2] * this.r1y * this.r1y + s[5] * this.r1x * this.r1y),
                    (a[7] += (s[3] * this.r1x - s[0] * this.r1y) * this.r1z - s[5] * this.r1x * this.r1x + s[2] * this.r1x * this.r1y),
                    (a[8] += s[0] * this.r1y * this.r1y - (s[3] + s[1]) * this.r1x * this.r1y + s[4] * this.r1x * this.r1x),
                    (a[0] += h[4] * this.r2z * this.r2z - (h[7] + h[5]) * this.r2y * this.r2z + h[8] * this.r2y * this.r2y),
                    (a[1] += (h[6] * this.r2y + h[5] * this.r2x) * this.r2z - h[3] * this.r2z * this.r2z - h[8] * this.r2x * this.r2y),
                    (a[2] += (h[3] * this.r2y - h[4] * this.r2x) * this.r2z - h[6] * this.r2y * this.r2y + h[7] * this.r2x * this.r2y),
                    (a[3] += (h[2] * this.r2y + h[7] * this.r2x) * this.r2z - h[1] * this.r2z * this.r2z - h[8] * this.r2x * this.r2y),
                    (a[4] += h[0] * this.r2z * this.r2z - (h[6] + h[2]) * this.r2x * this.r2z + h[8] * this.r2x * this.r2x),
                    (a[5] += (h[1] * this.r2x - h[0] * this.r2y) * this.r2z - h[7] * this.r2x * this.r2x + h[6] * this.r2x * this.r2y),
                    (a[6] += (h[1] * this.r2y - h[4] * this.r2x) * this.r2z - h[2] * this.r2y * this.r2y + h[5] * this.r2x * this.r2y),
                    (a[7] += (h[3] * this.r2x - h[0] * this.r2y) * this.r2z - h[5] * this.r2x * this.r2x + h[2] * this.r2x * this.r2y),
                    (a[8] += h[0] * this.r2y * this.r2y - (h[3] + h[1]) * this.r2x * this.r2y + h[4] * this.r2x * this.r2x);
                ...
                n > 0.005
                    ? ((n = ((0.005 - n) / n) * i * 0.05), (this.velx *= n), (this.vely *= n), (this.velz *= n))
            ...
            solve: function () {
                ...
                (this.impx += e),
                    ...
                    (this.l1.y += a * this.m1),
                    (this.l1.z += o * this.m1),
                    (this.a1.x += e * this.ax1x + a * this.ay1x + o * this.az1x),
                    (this.a1.y += e * this.ax1y + a * this.ay1y + o * this.az1y),
                    (this.a1.z += e * this.ax1z + a * this.ay1z + o * this.az1z),
                    (this.l2.x -= e * this.m2),
                    (this.l2.y -= a * this.m2),
                    (this.l2.z -= o * this.m2),
                    (this.a2.x -= e * this.ax2x + a * this.ay2x + o * this.az2x),
                    (this.a2.y -= e * this.ax2y + a * this.ay2y + o * this.az2y),
                    (this.a2.z -= e * this.ax2z + a * this.ay2z + o * this.az2z);
            },
        }),
        Object.assign(W.prototype, {
            ...
            preSolve: function (t, i) {
                ...
                c
                    ? (this.lowerLimit1 == this.upperLimit1
                          ? (0 != this.limitState1 && ((this.limitState1 = 0), (this.limitImpulse1 = 0)),
                            (this.limitVelocity1 = this.lowerLimit1 - u))
                          : u < this.lowerLimit1
                          ? (-1 != this.limitState1 && ((this.limitState1 = -1), (this.limitImpulse1 = 0)),
                            (this.limitVelocity1 = this.lowerLimit1 - u))
                          : u > this.upperLimit1
                          ? (1 != this.limitState1 && ((this.limitState1 = 1), (this.limitImpulse1 = 0)),
                            (this.limitVelocity1 = this.upperLimit1 - u))
                ...
                if (
                    (p
                        ? (this.lowerLimit3 == this.upperLimit3
                              ? (0 != this.limitState3 && ((this.limitState3 = 0), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.lowerLimit3 - x))
                              : x < this.lowerLimit3
                              ? (-1 != this.limitState3 && ((this.limitState3 = -1), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.lowerLimit3 - x))
                              : x > this.upperLimit3
                              ? (1 != this.limitState3 && ((this.limitState3 = 1), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.upperLimit3 - x))
                    ...
                    n && 2 != this.limitState1)
                ) {
                    var d = 6.2831853 * e,
                        f = d * d * t,
                        b = i / (f + 2 * this.limitMotor1.dampingRatio * d);
                    (this.cfm1 = this.kv00 * b), (this.limitVelocity1 *= f * b);
                } else (this.cfm1 = 0), (this.limitVelocity1 *= 0.05 * i);
                r && 2 != this.limitState2
                    ? ((b = i / ((f = (d = 6.2831853 * a) * d * t) + 2 * this.limitMotor2.dampingRatio * d)),
                      (this.cfm2 = this.kv11 * b),
                      (this.limitVelocity2 *= f * b))
                    : ((this.cfm2 = 0), (this.limitVelocity2 *= 0.05 * i)),
                    l && 2 != this.limitState3
                        ? ((b = i / ((f = (d = 6.2831853 * o) * d * t) + 2 * this.limitMotor3.dampingRatio * d)),
                          (this.cfm3 = this.kv22 * b),
                          (this.limitVelocity3 *= f * b))
                        : ((this.cfm3 = 0), (this.limitVelocity3 *= 0.05 * i)),
                    (this.k00 += this.cfm1),
                    (this.k11 += this.cfm2),
                    (this.k22 += this.cfm3);
                var v =
                ...
                (this.d00 = (this.k11 * this.k22 - this.k12 * this.k21) * v),
                    (this.d01 = (this.k02 * this.k21 - this.k01 * this.k22) * v),
                    (this.d02 = (this.k01 * this.k12 - this.k02 * this.k11) * v),
                    (this.d10 = (this.k12 * this.k20 - this.k10 * this.k22) * v),
                    (this.d11 = (this.k00 * this.k22 - this.k02 * this.k20) * v),
                    (this.d12 = (this.k02 * this.k10 - this.k00 * this.k12) * v),
                    (this.d20 = (this.k10 * this.k21 - this.k11 * this.k20) * v),
                    (this.d21 = (this.k01 * this.k20 - this.k00 * this.k21) * v),
                    (this.d22 = (this.k00 * this.k11 - this.k01 * this.k10) * v),
                ...
                (this.a1.x += z * this.a1x1 + N * this.a1x2 + k * this.a1x3),
                    (this.a1.y += z * this.a1y1 + N * this.a1y2 + k * this.a1y3),
                    (this.a1.z += z * this.a1z1 + N * this.a1z2 + k * this.a1z3),
                    (this.a2.x -= z * this.a2x1 + N * this.a2x2 + k * this.a2x3),
                    (this.a2.y -= z * this.a2y1 + N * this.a2y2 + k * this.a2y3),
                    (this.a2.z -= z * this.a2z1 + N * this.a2z2 + k * this.a2z3);
            },
            solve_: function () {
                ...
                (this.limitImpulse1 += o),
                    (this.limitImpulse2 += n),
                    (this.limitImpulse3 += r),
                    (this.a1.x += o * this.a1x1 + n * this.a1x2 + r * this.a1x3),
                    (this.a1.y += o * this.a1y1 + n * this.a1y2 + r * this.a1y3),
                    (this.a1.z += o * this.a1z1 + n * this.a1z2 + r * this.a1z3),
                    (this.a2.x -= o * this.a2x1 + n * this.a2x2 + r * this.a2x3),
                    (this.a2.y -= o * this.a2y1 + n * this.a2y2 + r * this.a2y3),
                    (this.a2.z -= o * this.a2z1 + n * this.a2z2 + r * this.a2z3);
            },
            solve: function () {
                var t = this.a2.x - this.a1.x,
                    i = this.a2.y - this.a1.y,
                    ...
                    m = 0;
                this.enableMotor1 &&
                    ((l = (h - this.motorSpeed1) * this.dv00),
                    (this.motorImpulse1 += l),
                    ...
                    (l = this.motorImpulse1 - o)),
                    this.enableMotor2 &&
                        ((c = (e - this.motorSpeed2) * this.dv11),
                        (this.motorImpulse2 += c),
                        ...
                        (c = this.motorImpulse2 - n)),
                    this.enableMotor3 &&
                        ((m = (a - this.motorSpeed3) * this.dv22),
                        (this.motorImpulse3 += m),
                        ...
                        (m = this.motorImpulse3 - r)),
                    (h += l * this.kv00 + c * this.k01 + m * this.k02),
                    (e += l * this.k10 + c * this.kv11 + m * this.k12),
                    (a += l * this.k20 + c * this.k21 + m * this.kv22),
                    (h -= this.limitVelocity1 + this.limitImpulse1 * this.cfm1),
                    (e -= this.limitVelocity2 + this.limitImpulse2 * this.cfm2),
                    (a -= this.limitVelocity3 + this.limitImpulse3 * this.cfm3);
                ...
                switch (
                    ((2 == this.limitState1 || this.limitImpulse1 * this.limitState1 < 0) &&
                        ((e += (x = -p) * this.k10), (a += x * this.k20), (v |= 1)),
                    (2 == this.limitState2 || this.limitImpulse2 * this.limitState2 < 0) &&
                        ((h += (d = -u) * this.k01), (a += d * this.k21), (v |= 2)),
                    (2 == this.limitState3 || this.limitImpulse3 * this.limitState3 < 0) &&
                        ((h += (f = -y) * this.k02), (e += f * this.k12), (v |= 4)),
                    v)
                ) {
                    case 1:
                        (b = 1 / (this.k11 * this.k22 - this.k12 * this.k21)),
                            (d = (this.k22 * e + -this.k12 * a) * b),
                            (f = (-this.k21 * e + this.k11 * a) * b);
                        break;
                    case 2:
                        (b = 1 / (this.k00 * this.k22 - this.k02 * this.k20)),
                            (x = (this.k22 * h + -this.k02 * a) * b),
                            (f = (-this.k20 * h + this.k00 * a) * b);
                        break;
                    case 3:
                        f = a / this.k22;
                        break;
                    case 4:
                        (b = 1 / (this.k00 * this.k11 - this.k01 * this.k10)),
                            (x = (this.k11 * h + -this.k01 * e) * b),
                            (d = (-this.k10 * h + this.k00 * e) * b);
                        break;
                    case 5:
                        d = e / this.k11;
                        break;
        ...
        (H.prototype = Object.assign(Object.create(_.prototype), {
            ...
            preSolve: function (t, i) {
                ...
                this.tmp.crossVectors(this.an1, this.an2),
                    g.dotVectors(this.nor, this.tmp) < 0 ? (this.limitMotor.angle = -s) : (this.limitMotor.angle = s),
                    this.tmp.crossVectors(this.ax1, this.ax2),
                    (this.r3.limitMotor2.angle = g.dotVectors(this.tan, this.tmp)),
                    (this.r3.limitMotor3.angle = g.dotVectors(this.bin, this.tmp)),
                    this.r3.preSolve(t, i),
                    this.lc.preSolve(t, i);
            },
            solve: function () {
        ...
        Object.assign(X.prototype, {
            ...
            preSolve: function (t, i) {
                ...
                ((l && n > 20) || n < -20) && (l = !1),
                    this.lowerLimit <= this.upperLimit
                        ? (this.lowerLimit == this.upperLimit
                              ? (0 != this.limitState && ((this.limitState = 0), (this.limitImpulse = 0)),
                                (this.limitVelocity = this.lowerLimit - n),
                                l || (n = this.lowerLimit))
                              : n < this.lowerLimit
                              ...
                              : n > this.upperLimit
                              ? (1 != this.limitState && ((this.limitState = 1), (this.limitImpulse = 0)),
                                (this.limitVelocity = this.upperLimit - n),
                                l || (n = this.upperLimit))
                    ...
                    this.enableMotor && (0 != this.limitState || l)
                ...
                var c = n * this.ax,
                    ...
                    y = 1 - u;
                if (
                    ((this.r1x = this.r1.x + c * u),
                    (this.r1y = this.r1.y + m * u),
                    (this.r1z = this.r1.z + p * u),
                    (this.r2x = this.r2.x - c * y),
                    (this.r2y = this.r2.y - m * y),
                    (this.r2z = this.r2.z - p * y),
                ...
                } else (this.cfm = 0), (this.limitVelocity *= 0.05 * i);
                this.invDenom = 1 / (this.motorDenom + this.cfm);
                var b = this.limitImpulse + this.motorImpulse;
                (this.l1.x += b * this.l1x),
                    (this.l1.y += b * this.l1y),
                    (this.l1.z += b * this.l1z),
                    (this.a1.x += b * this.a1x),
                    (this.a1.y += b * this.a1y),
                    (this.a1.z += b * this.a1z),
                    (this.l2.x -= b * this.l2x),
                    (this.l2.y -= b * this.l2y),
                    (this.l2.z -= b * this.l2z),
                    (this.a2.x -= b * this.a2x),
                    (this.a2.y -= b * this.a2y),
                    (this.a2.z -= b * this.a2z);
            },
            solve: function () {
                var t,
                    i,
                ...
                if (this.enableMotor) {
                    ...
                    (this.motorImpulse += t),
                        ...
                        (s -= (t = this.motorImpulse - h) * this.motorDenom);
                } else t = 0;
                if (2 != this.limitState) {
                    ...
                    (this.limitImpulse += i),
                        ...
                        (i = this.limitImpulse - e);
                } else i = 0;
                var a = i + t;
                (this.l1.x += a * this.l1x),
                    (this.l1.y += a * this.l1y),
                    (this.l1.z += a * this.l1z),
                    (this.a1.x += a * this.a1x),
                    (this.a1.y += a * this.a1y),
                    (this.a1.z += a * this.a1z),
                    (this.l2.x -= a * this.l2x),
                    (this.l2.y -= a * this.l2y),
                    (this.l2.z -= a * this.l2z),
                    (this.a2.x -= a * this.a2x),
                    (this.a2.y -= a * this.a2y),
                    (this.a2.z -= a * this.a2z);
            },
        }),
        ...
        Object.assign(Z.prototype, {
            ...
            preSolve: function (t, i) {
                ...
                (this.ii1 = this.i1.clone()),
                    ...
                    (s =
                        1 /
                        ((e = new P().add(this.ii1, this.ii2).elements)[0] * (e[4] * e[8] - e[7] * e[5]) +
                            e[3] * (e[7] * e[2] - e[1] * e[8]) +
                            e[6] * (e[1] * e[5] - e[4] * e[2]))),
                    (this.dd = new P()
                        .set(
                    ...
                    (s = 2 * this.relativeOrientation.w),
                    this.vel.copy(this.relativeOrientation).multiplyScalar(s),
                    (h = this.vel.length()) > 0.02
                        ? ((h = ((0.02 - h) / h) * i * 0.05), this.vel.multiplyScalar(h))
                        : this.vel.set(0, 0, 0),
            ...
            preSolve: function (t, i) {
                ...
                ((u && n > 20) || n < -20) && (u = !1),
                    ...
                    d
                        ? (this.lowerLimit1 == this.upperLimit1
                              ? (0 != this.limitState1 && ((this.limitState1 = 0), (this.limitImpulse1 = 0)),
                                (this.limitVelocity1 = this.lowerLimit1 - n),
                                u || (n = this.lowerLimit1))
                              : n < this.lowerLimit1
                              ? (-1 != this.limitState1 && ((this.limitState1 = -1), (this.limitImpulse1 = 0)),
                                (this.limitVelocity1 = this.lowerLimit1 - n),
                                u || (n = this.lowerLimit1))
                              : n > this.upperLimit1
                              ? (1 != this.limitState1 && ((this.limitState1 = 1), (this.limitImpulse1 = 0)),
                                (this.limitVelocity1 = this.upperLimit1 - n),
                                u || (n = this.upperLimit1))
                              : ((this.limitState1 = 2), (this.limitImpulse1 = 0), (this.limitVelocity1 = 0)),
                          u ||
                    ...
                    f
                        ? (this.lowerLimit2 == this.upperLimit2
                              ? (0 != this.limitState2 && ((this.limitState2 = 0), (this.limitImpulse2 = 0)),
                                (this.limitVelocity2 = this.lowerLimit2 - r),
                                y || (r = this.lowerLimit2))
                              : r < this.lowerLimit2
                              ? (-1 != this.limitState2 && ((this.limitState2 = -1), (this.limitImpulse2 = 0)),
                                (this.limitVelocity2 = this.lowerLimit2 - r),
                                y || (r = this.lowerLimit2))
                              : r > this.upperLimit2
                              ? (1 != this.limitState2 && ((this.limitState2 = 1), (this.limitImpulse2 = 0)),
                                (this.limitVelocity2 = this.upperLimit2 - r),
                                y || (r = this.upperLimit2))
                              : ((this.limitState2 = 2), (this.limitImpulse2 = 0), (this.limitVelocity2 = 0)),
                          y ||
                    ...
                    b
                        ? (this.lowerLimit3 == this.upperLimit3
                              ? (0 != this.limitState3 && ((this.limitState3 = 0), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.lowerLimit3 - l),
                                x || (l = this.lowerLimit3))
                              : l < this.lowerLimit3
                              ? (-1 != this.limitState3 && ((this.limitState3 = -1), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.lowerLimit3 - l),
                                x || (l = this.lowerLimit3))
                              : l > this.upperLimit3
                              ? (1 != this.limitState3 && ((this.limitState3 = 1), (this.limitImpulse3 = 0)),
                                (this.limitVelocity3 = this.upperLimit3 - l),
                                x || (l = this.upperLimit3))
                              : ((this.limitState3 = 2), (this.limitImpulse3 = 0), (this.limitVelocity3 = 0)),
                          x ||
                              (this.limitVelocity3 > 0.005
                                  ...
                                  : (this.limitVelocity3 = 0)))
                        : ((this.limitState3 = 2), (this.limitImpulse3 = 0)),
                    this.enableMotor1 && (0 != this.limitState1 || u)
                        ? (this.maxMotorImpulse1 = this.maxMotorForce1 * t)
                        : ((this.motorImpulse1 = 0), (this.maxMotorImpulse1 = 0)),
                    this.enableMotor2 && (0 != this.limitState2 || y)
                        ? (this.maxMotorImpulse2 = this.maxMotorForce2 * t)
                        : ((this.motorImpulse2 = 0), (this.maxMotorImpulse2 = 0)),
                    this.enableMotor3 && (0 != this.limitState3 || x)
                        ? (this.maxMotorImpulse3 = this.maxMotorForce3 * t)
                        : ((this.motorImpulse3 = 0), (this.maxMotorImpulse3 = 0));
                ...
                var w = 1 - k;
                (this.r1x = this.r1.x + v * k),
                    (this.r1y = this.r1.y + z * k),
                    (this.r1z = this.r1.z + N * k),
                    (this.r2x = this.r2.x - v * w),
                    (this.r2y = this.r2.y - z * w),
                    (this.r2z = this.r2.z - N * w),
                ...
                if (
                    ((this.k00 = (this.ax1 * this.ax1 + this.ay1 * this.ay1 + this.az1 * this.az1) * M),
                    (this.k01 = (this.ax1 * this.ax2 + this.ay1 * this.ay2 + this.az1 * this.az2) * M),
                    (this.k02 = (this.ax1 * this.ax3 + this.ay1 * this.ay3 + this.az1 * this.az3) * M),
                    (this.k10 = (this.ax2 * this.ax1 + this.ay2 * this.ay1 + this.az2 * this.az1) * M),
                    (this.k11 = (this.ax2 * this.ax2 + this.ay2 * this.ay2 + this.az2 * this.az2) * M),
                    (this.k12 = (this.ax2 * this.ax3 + this.ay2 * this.ay3 + this.az2 * this.az3) * M),
                    (this.k20 = (this.ax3 * this.ax1 + this.ay3 * this.ay1 + this.az3 * this.az1) * M),
                    (this.k21 = (this.ax3 * this.ax2 + this.ay3 * this.ay2 + this.az3 * this.az2) * M),
                    (this.k22 = (this.ax3 * this.ax3 + this.ay3 * this.ay3 + this.az3 * this.az3) * M),
                ...
                y && 2 != this.limitState2
                    ? ((V = i / ((I = (g = 6.2831853 * m) * g * t) + 2 * this.limitMotor2.dampingRatio * g)),
                      (this.cfm2 = this.kv11 * V),
                      (this.limitVelocity2 *= I * V))
                    : ((this.cfm2 = 0), (this.limitVelocity2 *= 0.05 * i)),
                    x && 2 != this.limitState3
                        ? ((V = i / ((I = (g = 6.2831853 * p) * g * t) + 2 * this.limitMotor3.dampingRatio * g)),
                          (this.cfm3 = this.kv22 * V),
                          (this.limitVelocity3 *= I * V))
                        : ((this.cfm3 = 0), (this.limitVelocity3 *= 0.05 * i)),
                    (this.k00 += this.cfm1),
                    (this.k11 += this.cfm2),
                    (this.k22 += this.cfm3);
                var L =
                    ...
                    (this.k00 * (this.k11 * this.k22 - this.k21 * this.k12) +
                        this.k10 * (this.k21 * this.k02 - this.k01 * this.k22) +
                        this.k20 * (this.k01 * this.k12 - this.k11 * this.k02));
                (this.d00 = (this.k11 * this.k22 - this.k12 * this.k21) * L),
                    (this.d01 = (this.k02 * this.k21 - this.k01 * this.k22) * L),
                    (this.d02 = (this.k01 * this.k12 - this.k02 * this.k11) * L),
                    (this.d10 = (this.k12 * this.k20 - this.k10 * this.k22) * L),
                    (this.d11 = (this.k00 * this.k22 - this.k02 * this.k20) * L),
                    (this.d12 = (this.k02 * this.k10 - this.k00 * this.k12) * L),
                    (this.d20 = (this.k10 * this.k21 - this.k11 * this.k20) * L),
                    (this.d21 = (this.k01 * this.k20 - this.k00 * this.k21) * L),
                    (this.d22 = (this.k00 * this.k11 - this.k01 * this.k10) * L);
                ...
                (this.l1.x += S * this.l1x1 + P * this.l1x2 + T * this.l1x3),
                    (this.l1.y += S * this.l1y1 + P * this.l1y2 + T * this.l1y3),
                    (this.l1.z += S * this.l1z1 + P * this.l1z2 + T * this.l1z3),
                    (this.a1.x += S * this.a1x1 + P * this.a1x2 + T * this.a1x3),
                    (this.a1.y += S * this.a1y1 + P * this.a1y2 + T * this.a1y3),
                    (this.a1.z += S * this.a1z1 + P * this.a1z2 + T * this.a1z3),
                    (this.l2.x -= S * this.l2x1 + P * this.l2x2 + T * this.l2x3),
                    (this.l2.y -= S * this.l2y1 + P * this.l2y2 + T * this.l2y3),
                    (this.l2.z -= S * this.l2z1 + P * this.l2z2 + T * this.l2z3),
                    (this.a2.x -= S * this.a2x1 + P * this.a2x2 + T * this.a2x3),
                    (this.a2.y -= S * this.a2y1 + P * this.a2y2 + T * this.a2y3),
                    (this.a2.z -= S * this.a2z1 + P * this.a2z2 + T * this.a2z3);
            },
            solve: function () {
                ...
                var z = l + x,
                    N = c + d,
                    k = m + f;
                (this.l1.x += z * this.l1x1 + N * this.l1x2 + k * this.l1x3),
                    (this.l1.y += z * this.l1y1 + N * this.l1y2 + k * this.l1y3),
                    (this.l1.z += z * this.l1z1 + N * this.l1z2 + k * this.l1z3),
                    (this.a1.x += z * this.a1x1 + N * this.a1x2 + k * this.a1x3),
                    (this.a1.y += z * this.a1y1 + N * this.a1y2 + k * this.a1y3),
                    (this.a1.z += z * this.a1z1 + N * this.a1z2 + k * this.a1z3),
                    (this.l2.x -= z * this.l2x1 + N * this.l2x2 + k * this.l2x3),
                    (this.l2.y -= z * this.l2y1 + N * this.l2y2 + k * this.l2y3),
                    (this.l2.z -= z * this.l2z1 + N * this.l2z2 + k * this.l2z3),
                    (this.a2.x -= z * this.a2x1 + N * this.a2x2 + k * this.a2x3),
                    (this.a2.y -= z * this.a2y1 + N * this.a2y2 + k * this.a2y3),
                    (this.a2.z -= z * this.a2z1 + N * this.a2z2 + k * this.a2z3);
            },
        ...
        (G.prototype = Object.assign(Object.create(_.prototype), {
            ...
            preSolve: function (t, i) {
                this.updateAnchorPoints(),
                    ...
                    this.tan.tangent(this.nor).normalize(),
                    this.bin.crossVectors(this.nor, this.tan),
                    this.ac.preSolve(t, i),
                    this.t3.preSolve(t, i);
            },
            solve: function () {
        ...
        ($.prototype = Object.assign(Object.create(_.prototype), {
            ...
            preSolve: function (t, i) {
                this.updateAnchorPoints(),
                    ...
                    this.tmp.crossVectors(this.an1, this.an2);
                var s = g.acosClamp(g.dotVectors(this.an1, this.an2));
                g.dotVectors(this.nor, this.tmp) < 0 ? (this.rotationalLimitMotor.angle = -s) : (this.rotationalLimitMotor.angle = s),
                    this.tmp.crossVectors(this.ax1, this.ax2),
                    (this.r3.limitMotor2.angle = g.dotVectors(this.tan, this.tmp)),
                    (this.r3.limitMotor3.angle = g.dotVectors(this.bin, this.tmp)),
                    this.r3.preSolve(t, i),
        ...
        (tt.prototype = Object.assign(Object.create(_.prototype), {
            ...
            preSolve: function (t, i) {
                this.updateAnchorPoints(),
                    ...
                    this.ax2.copy(this.localAxis2).applyMatrix3(this.body2.rotation, !0),
                    this.an2.copy(this.localAngle2).applyMatrix3(this.body2.rotation, !0),
                    (this.r3.limitMotor1.angle = g.dotVectors(this.ax1, this.ax2));
                var s = g.dotVectors(this.an1, this.ax2);
                g.dotVectors(this.ax1, this.tmp.crossVectors(this.an1, this.ax2)) < 0
                    ? (this.rotationalLimitMotor1.angle = -s)
                    : (this.rotationalLimitMotor1.angle = s),
                    (s = g.dotVectors(this.an2, this.ax1)),
                    g.dotVectors(this.ax2, this.tmp.crossVectors(this.an2, this.ax1)) < 0
                        ? (this.rotationalLimitMotor2.angle = -s)
                        : (this.rotationalLimitMotor2.angle = s),
        ...
        (ot.prototype = {
            ...
            addPointVec: function (t, i, s, h) {
                ...
                e.position.copy(t),
                    e.localPoint1.sub(t, this.body1.position).applyMatrix3(this.body1.rotation),
                    e.localPoint2.sub(t, this.body2.position).applyMatrix3(this.body2.rotation),
                    e.normal.copy(i),
                    h && e.normal.negate(),
                    (e.normalImpulse = 0),
                    (e.penetration = s),
            ...
            addPoint: function (t, i, s, h, e, a, o, n) {
                ...
                r.position.set(t, i, s),
                    r.localPoint1.sub(r.position, this.body1.position).applyMatrix3(this.body1.rotation),
                    r.localPoint2.sub(r.position, this.body2.position).applyMatrix3(this.body2.rotation),
                    (r.normalImpulse = 0),
                    r.normal.set(h, e, a),
                    n && r.normal.negate(),
                    (r.penetration = o),
        ...
        (rt.prototype = Object.assign(Object.create(U.prototype), {
            ...
            preSolve: function (t, i) {
                ...
                for (var h, e, a, o, n, r, l, c = this.cs, m = 0; m < this.num; m++)
                    (h = this.ps[m]),
                        this.tmpP1.sub(h.position, this.p1),
                        this.tmpP2.sub(h.position, this.p2),
                        this.tmpC1.crossVectors(this.av1, this.tmpP1),
                        this.tmpC2.crossVectors(this.av2, this.tmpP2),
                        (c.norImp = h.normalImpulse),
                        (c.tanImp = h.tangentImpulse),
                        (c.binImp = h.binormalImpulse),
                        c.nor.copy(h.normal),
                        this.tmp.set(
                        ...
                        (e = g.dotVectors(c.nor, this.tmp)),
                        c.tan.set(this.tmp.x - e * c.nor.x, this.tmp.y - e * c.nor.y, this.tmp.z - e * c.nor.z),
                        g.dotVectors(c.tan, c.tan) <= 0.04 && c.tan.tangent(c.nor),
                        c.tan.normalize(),
                        ...
                        (r = this.i1),
                        (l = this.i2),
                        c.norTU1.copy(c.norT1).applyMatrix3(r, !0),
                        c.tanTU1.copy(c.tanT1).applyMatrix3(r, !0),
                        c.binTU1.copy(c.binT1).applyMatrix3(r, !0),
                        c.norTU2.copy(c.norT2).applyMatrix3(l, !0),
                        c.tanTU2.copy(c.tanT2).applyMatrix3(l, !0),
                        c.binTU2.copy(c.binT2).applyMatrix3(l, !0),
                        this.tmpC1.crossVectors(c.norTU1, this.tmpP1),
                        this.tmpC2.crossVectors(c.norTU2, this.tmpP2),
                        this.tmp.add(this.tmpC1, this.tmpC2),
                        (c.norDen = 1 / (s + g.dotVectors(c.nor, this.tmp))),
                        this.tmpC1.crossVectors(c.tanTU1, this.tmpP1),
                        this.tmpC2.crossVectors(c.tanTU2, this.tmpP2),
                        this.tmp.add(this.tmpC1, this.tmpC2),
                        (c.tanDen = 1 / (s + g.dotVectors(c.tan, this.tmp))),
                        this.tmpC1.crossVectors(c.binTU1, this.tmpP1),
                        this.tmpC2.crossVectors(c.binTU2, this.tmpP2),
                        this.tmp.add(this.tmpC1, this.tmpC2),
                        (c.binDen = 1 / (s + g.dotVectors(c.bin, this.tmp))),
                        h.warmStarted
                            ? ((a = h.normalImpulse),
                              this.lv1.addScaledVector(c.norU1, a),
                              this.av1.addScaledVector(c.norTU1, a),
                              this.lv2.subScaledVector(c.norU2, a),
                              this.av2.subScaledVector(c.norTU2, a),
                              (c.norImp = a),
                              (c.tanImp = 0),
                              (c.binImp = 0),
                              (e = 0))
                            : ((c.norImp = 0), (c.tanImp = 0), (c.binImp = 0)),
                        e > -1 && (e = 0),
                        (o = this.restitution * -e) < (n = -(h.penetration + 0.005) * i * 0.05) && (o = n),
                        (c.norTar = o),
                        (c.last = m == this.num - 1),
                        (c = c.next);
            },
            solve: function () {
                ...
                for (
                    ...
                    (e = l.norImp),
                        ...
                        (r =
                            (a += i =
                                (g.dotVectors(this.tmp, l.tan) + g.dotVectors(this.tmpav2, l.tanT2) - g.dotVectors(this.tmpav1, l.tanT1)) *
                                l.tanDen) *
                                a +
                            (o += h =
                                (g.dotVectors(this.tmp, l.bin) + g.dotVectors(this.tmpav2, l.binT2) - g.dotVectors(this.tmpav1, l.binT1)) *
                                l.binDen) *
                                o) >
                            n * n && ((a *= r = n / g.sqrt(r)), (o *= r)),
                        (i = a - t),
                        (h = o - s),
                        this.tmp.set(l.tanU1.x * i + l.binU1.x * h, l.tanU1.y * i + l.binU1.y * h, l.tanU1.z * i + l.binU1.z * h),
                        this.tmplv1.addEqual(this.tmp),
                        this.tmp.set(l.tanTU1.x * i + l.binTU1.x * h, l.tanTU1.y * i + l.binTU1.y * h, l.tanTU1.z * i + l.binTU1.z * h),
                        this.tmpav1.addEqual(this.tmp),
                        this.tmp.set(l.tanU2.x * i + l.binU2.x * h, l.tanU2.y * i + l.binU2.y * h, l.tanU2.z * i + l.binU2.z * h),
                        this.tmplv2.subEqual(this.tmp),
                        this.tmp.set(l.tanTU2.x * i + l.binTU2.x * h, l.tanTU2.y * i + l.binTU2.y * h, l.tanTU2.z * i + l.binTU2.z * h),
                        this.tmpav2.subEqual(this.tmp),
                        this.tmp.sub(this.tmplv2, this.tmplv1),
                        (t = e),
                        (e += i =
                            (g.dotVectors(this.tmp, l.nor) +
                                g.dotVectors(this.tmpav2, l.norT2) -
                                g.dotVectors(this.tmpav1, l.norT1) -
                                l.norTar) *
                            l.norDen) > 0 && (e = 0),
                        (i = e - t),
                        this.tmplv1.addScaledVector(l.norU1, i),
                        this.tmpav1.addScaledVector(l.norTU1, i),
                        this.tmplv2.subScaledVector(l.norU2, i),
                        this.tmpav2.subScaledVector(l.norTU2, i),
                        (l.norImp = e),
                        (l.tanImp = a),
                        (l.binImp = o),
                        !l.last;
            ...
            postSolve: function () {
                for (var t, i = this.cs, s = this.num; s--; )
                    (t = this.ps[s]).normal.copy(i.nor),
                        t.tangent.copy(i.tan),
                        t.binormal.copy(i.bin),
                        (t.normalImpulse = i.norImp),
                        (t.tangentImpulse = i.tanImp),
                        (t.binormalImpulse = i.binImp),
                        (t.normalDenominator = i.norDen),
                        (t.tangentDenominator = i.tanDen),
                        (t.binormalDenominator = i.binDen),
                        (i = i.next);
            },
        })),
        Object.assign(lt.prototype, {
            ...
            updateManifold: function () {
                ...
                for (var t = this.manifold.numPoints, i = t; i--; ) {
                    var s = this.buffer[i],
                        h = this.points[i];
                    (s.lp1X = h.localPoint1.x),
                        (s.lp1Y = h.localPoint1.y),
                        (s.lp1Z = h.localPoint1.z),
                        (s.lp2X = h.localPoint2.x),
                        (s.lp2Y = h.localPoint2.y),
                        (s.lp2Z = h.localPoint2.z),
                        (s.impulse = h.normalImpulse);
                }
                ...
                for ((this.touching || this.dist < 0.001) && (this.close = !0), this.touching = !0, i = e; i--; ) {
                    for (
                        var a = (h = this.points[i]).localPoint1.x,
                            o = h.localPoint1.y,
                            n = h.localPoint1.z,
                            r = h.localPoint2.x,
                            l = h.localPoint2.y,
            ...
            attach: function (t, i) {
                (this.shape1 = t),
                    ...
                    t.numContacts++,
                    null != i.contactLink ? ((this.s2Link.next = i.contactLink).prev = this.s2Link) : (this.s2Link.next = null),
                    (i.contactLink = this.s2Link),
                    i.numContacts++,
                    (this.b1Link.shape = i),
                    (this.b1Link.body = this.body2),
                    (this.b2Link.shape = t),
            ...
            detach: function () {
                ...
                null !== t && (t.next = i),
                    null !== i && (i.prev = t),
                    this.shape1.contactLink == this.s1Link && (this.shape1.contactLink = i),
                    ...
                    null !== t && (t.next = i),
                    null !== i && (i.prev = t),
                    this.shape2.contactLink == this.s2Link && (this.shape2.contactLink = i),
                    ...
                    null !== t && (t.next = i),
                    null !== i && (i.prev = t),
                    this.body1.contactLink == this.b1Link && (this.body1.contactLink = i),
                    (this.b1Link.prev = null),
                    (this.b1Link.next = null),
                    ...
                    null !== t && (t.next = i),
                    null !== i && (i.prev = t),
                    this.body2.contactLink == this.b2Link && (this.body2.contactLink = i),
                    (this.b2Link.prev = null),
                    (this.b2Link.next = null),
        ...
        Object.assign(ct.prototype, {
            ...
            addShape: function (t) {
                t.parent && I("RigidBody", "It is not possible that you add a shape which already has an associated body."),
            ...
            removeShape: function (t) {
                ...
                if (i.parent == this) {
                    ...
                    null != s && (s.next = h),
                        null != h && (h.prev = s),
                        this.shapes == i && (this.shapes = h),
                        (i.prev = null),
                        (i.next = null),
                        (i.parent = null),
                        this.parent && this.parent.removeShape(i),
                        this.numShapes--;
                }
            },
            remove: function () {
            ...
            setupMass: function (t, i) {
                ...
                for (var h = new P(), e = new L(), a = this.shapes; null !== a; a = a.next) {
                    ...
                    e.addScaledVector(a.relativePosition, o),
                        (this.mass += o),
                        this.rotateInertia(a.relativeRotation, this.massInfo.inertia, h),
                        this.localInertia.add(h),
                        this.localInertia.addOffset(o, a.relativePosition);
                }
            ...
            resetPosition: function (t, i, s) {
                this.linearVelocity.set(0, 0, 0),
                    this.angularVelocity.set(0, 0, 0),
                    this.position.set(t, i, s).multiplyScalar(this.invScale),
                    this.awake();
            },
            ...
            resetRotation: function (t, i, s) {
                this.angularVelocity.set(0, 0, 0),
                    (this.orientation = new S().setFromEuler(t * g.degtorad, i * g.degtorad, s * g.degtorad)),
                    this.awake();
            },
            getPosition: function () {
                return this.pos;
        ...
        Object.assign(pt.prototype, {
            ...
            isAvailablePair: function (t, i) {
                var s,
                    h = t.parent,
                    e = i.parent;
                if (h == e || (!h.isDynamic && !e.isDynamic) || 0 == (t.belongsTo & i.collidesWith) || 0 == (i.belongsTo & t.collidesWith))
                    return !1;
    ...
    function vt(t, i) {
        yt.call(this, i),
            ...
            (this.min = []),
            (this.sap = t),
            (this.min[0] = new bt(this, !1)),
            (this.max[0] = new bt(this, !0)),
            (this.min[1] = new bt(this, !1)),
            (this.max[1] = new bt(this, !0)),
            (this.min[2] = new bt(this, !1)),
            (this.max[2] = new bt(this, !0)),
    ...
    function zt() {
        pt.call(this),
            ...
            (this.numElementsD = 0),
            (this.numElementsS = 0),
            (this.axesD = [new ft(), new ft(), new ft()]),
            (this.axesS = [new ft(), new ft(), new ft()]),
            (this.index1 = 0),
            (this.index2 = 1);
    }
    function Nt() {
    ...
    function Ct(t) {
        ...
        (this.Btypes = ["None", "BruteForce", "Sweep & Prune", "Bounding Volume Tree"]),
            ...
            this.isStat && (this.performance = new V(this)),
        ...
        (this.detectors[u][u] = new Tt()),
            (this.detectors[u][y] = new St(!1)),
            (this.detectors[y][u] = new St(!0)),
            (this.detectors[y][y] = new It()),
            (this.detectors[x][x] = new Lt()),
            (this.detectors[x][y] = new Vt(!0)),
            (this.detectors[y][x] = new Vt(!1)),
            (this.detectors[x][u] = new Pt(!0)),
            (this.detectors[u][x] = new Pt(!1)),
            (this.detectors[d][u] = new At(!0)),
            (this.detectors[u][d] = new At(!1)),
            (this.detectors[d][y] = new jt(!0)),
            (this.detectors[y][d] = new jt(!1)),
            (this.randX = 65535),
            (this.randA = 98765),
    ...
    Object.assign(yt.prototype, {
        ...
        (xt.prototype = Object.assign(Object.create(yt.prototype), { constructor: xt, update: function () {} })),
        (dt.prototype = Object.assign(Object.create(pt.prototype), {
            ...
            collectPairs: function () {
                ...
                for (this.numPairChecks = (a * (a - 1)) >> 1; h < a; )
                    for (i = e[h++], t = h + 1; t < a; )
                        (s = e[t++]),
                            !i.aabb.intersectTest(s.aabb) && this.isAvailablePair(i.shape, s.shape) && this.addPair(i.shape, s.shape);
            },
        })),
                    ...
                    for (c[0] = 0, c[1] = this.numElements - 1; t > 0; ) {
                        ...
                        if (u > 16) {
                            ...
                            (h[m] = h[e]),
                                (h[e] = o),
                                e - p > m - e
                                    ? ((c[t++] = p), (c[t++] = e - 1), (c[t++] = e + 1), (c[t++] = m))
                                    : ((c[t++] = e + 1), (c[t++] = m), (c[t++] = p), (c[t++] = e - 1));
                        } else
                            for (e = p + 1; e <= m; e++)
        ...
        (vt.prototype = Object.assign(Object.create(yt.prototype), {
            ...
            update: function () {
                ...
                (this.min[0].value = t[0]),
                    (this.min[1].value = t[1]),
                    (this.min[2].value = t[2]),
                    (this.max[0].value = t[3]),
                    (this.max[1].value = t[4]),
                    (this.max[2].value = t[5]),
        ...
        (zt.prototype = Object.assign(Object.create(pt.prototype), {
            ...
            addProxy: function (t) {
                var i = t;
                i.isDynamic()
                    ? (this.axesD[0].addElements(i.min[0], i.max[0]),
                      this.axesD[1].addElements(i.min[1], i.max[1]),
                      this.axesD[2].addElements(i.min[2], i.max[2]),
                      (i.belongsTo = 1),
                      (this.numElementsD += 2))
                    : (this.axesS[0].addElements(i.min[0], i.max[0]),
                      this.axesS[1].addElements(i.min[1], i.max[1]),
                      this.axesS[2].addElements(i.min[2], i.max[2]),
                      (i.belongsTo = 2),
                      (this.numElementsS += 2));
            },
            removeProxy: function (t) {
                ...
                if (0 != i.belongsTo) {
                    switch (i.belongsTo) {
                        case 1:
                            this.axesD[0].removeElements(i.min[0], i.max[0]),
                                this.axesD[1].removeElements(i.min[1], i.max[1]),
                                this.axesD[2].removeElements(i.min[2], i.max[2]),
                                (this.numElementsD -= 2);
                            break;
                        case 2:
                            this.axesS[0].removeElements(i.min[0], i.max[0]),
                                this.axesS[1].removeElements(i.min[1], i.max[1]),
                                this.axesS[2].removeElements(i.min[2], i.max[2]),
                                (this.numElementsS -= 2);
                    }
                    i.belongsTo = 0;
                }
            ...
            collectPairs: function () {
                if (0 != this.numElementsD) {
                    ...
                    e.sort(),
                        a.sort(),
                        e.calculateTestCount() <= a.calculateTestCount()
                            ? ((a = this.axesS[this.index1]).sort(), (t = e.elements), (i = a.elements))
                            : ((e = this.axesS[this.index2]).sort(),
                              (t = a.elements),
                              (i = e.elements),
                    ...
                    for (var o = 0, n = 0; o < this.numElementsD; ) {
                        ...
                        if (r.max) {
                            ...
                            for (
                                var u = r.proxy.shape, y = r.min1.value, x = r.max1.value, d = r.min2.value, f = r.max2.value, b = s;
                                null != b;
                                b = b.pair
                            ) {
                                var v = b.proxy.shape;
        ...
        Object.assign(kt.prototype, {
                ...
                if (null != this.root) {
                    for (var i, s, h = t.aabb, e = this.root; null == e.proxy; ) {
                        ...
                        var c = 2 * (s = this.aabb.surfaceArea()),
                            m = 2 * (s - i),
                            p = m;
                        this.aabb.combine(h, r),
                            null != a.proxy ? (p += this.aabb.surfaceArea()) : (p += this.aabb.surfaceArea() - r.surfaceArea());
                        var u = m;
                        if (
                            (this.aabb.combine(h, l),
                            null != o.proxy ? (u += this.aabb.surfaceArea()) : (u += this.aabb.surfaceArea() - l.surfaceArea()),
                            p < u)
                        ) {
                            if (c < p) break;
                            e = a;
                    ...
                    var y,
                        x = e.parent;
                    ((y = this.numFreeNodes > 0 ? this.freeNodes[--this.numFreeNodes] : new Nt()).parent = x),
                        (y.child1 = t),
                        (y.child2 = e),
                        y.aabb.combine(t.aabb, e.aabb),
                        (y.height = e.height + 1),
                        (e.parent = y),
                        (t.parent = y),
                        e == this.root ? (this.root = y) : x.child1 == e ? (x.child1 = y) : (x.child2 = y);
                    do {
            ...
            deleteLeaf: function (t) {
                if (t != this.root) {
                    ...
                    var h = s.parent;
                    (i.parent = h),
                        h.child1 == s ? (h.child1 = i) : (h.child2 = i),
                        this.numFreeNodes < 16384 && (this.freeNodes[this.numFreeNodes++] = s);
                    do {
                    ...
                    return (
                        m > p
                            ? ((e.child2 = t),
                              ...
                              (t.child1 = c),
                              (c.parent = t),
                              t.aabb.combine(c.aabb, a.aabb),
                              (s = p - n),
                              (t.height = p - (s & (s >> 31)) + 1),
                              e.aabb.combine(l.aabb, t.aabb),
                              (s = m - i),
                              (e.height = m - (s & (s >> 31)) + 1))
                            : ((e.child1 = t),
                              (t.parent = e),
                              (t.child1 = l),
                              (l.parent = t),
                              t.aabb.combine(l.aabb, a.aabb),
                              (s = m - n),
                              (t.height = m - (s & (s >> 31)) + 1),
                              e.aabb.combine(t.aabb, c.aabb),
                              (s = i - p),
                              (e.height = i - (s & (s >> 31)) + 1)),
                        null != h ? (h.child1 == t ? (h.child1 = e) : (h.child2 = e)) : (this.root = e),
                        (e.parent = h),
                        e
                    );
                }
                    ...
                    return (
                        x > d
                            ? ((a.child2 = t),
                              ...
                              (t.child2 = y),
                              (y.parent = t),
                              t.aabb.combine(e.aabb, y.aabb),
                              (s = o - d),
                              (t.height = o - (s & (s >> 31)) + 1),
                              a.aabb.combine(u.aabb, t.aabb),
                              (s = x - i),
                              (a.height = x - (s & (s >> 31)) + 1))
                            : ((a.child1 = t),
                              (t.parent = a),
                              (t.child2 = u),
                              (u.parent = t),
                              t.aabb.combine(e.aabb, u.aabb),
                              (s = o - x),
                              (t.height = o - (s & (s >> 31)) + 1),
                              a.aabb.combine(t.aabb, y.aabb),
                              (s = i - d),
                              (a.height = i - (s & (s >> 31)) + 1)),
                        null != h ? (h.child1 == t ? (h.child1 = a) : (h.child2 = a)) : (this.root = a),
                        (a.parent = h),
                        a
                    );
                }
        ...
        (wt.prototype = Object.assign(Object.create(yt.prototype), { constructor: wt, update: function () {} })),
        (Mt.prototype = Object.assign(Object.create(pt.prototype), {
            ...
            collectPairs: function () {
                if (!(this.numLeaves < 2))
                    for (var t, i = this.numLeaves; i--; )
                        (t = this.leaves[i]).proxy.aabb.intersectTestTwo(t.aabb) &&
            ...
            collide: function (t, i) {
                ...
                for (this.stack[0] = t, this.stack[1] = i; r > 0; )
                    if (
                        ...
                        if ((s = e.proxy.shape) == (h = a.proxy.shape) || s.aabb.intersectTest(h.aabb) || !this.isAvailablePair(s, h))
                            continue;
                        this.addPair(s, h);
                    } else {
                        if (e.aabb.intersectTest(a.aabb)) continue;
                        n || (!o && e.aabb.surfaceArea() > a.aabb.surfaceArea())
                            ? ((this.stack[r++] = e.child1), (this.stack[r++] = a), (this.stack[r++] = e.child2), (this.stack[r++] = a))
                            : ((this.stack[r++] = e), (this.stack[r++] = a.child1), (this.stack[r++] = e), (this.stack[r++] = a.child2));
                    }
            },
        })),
        ...
        (It.prototype = Object.assign(Object.create(gt.prototype), {
            ...
            detectCollision: function (t, i, s) {
                ...
                var a,
                    ...
                    gi = !1;
                if (
                    ((a = (D = rt * $ + lt * tt + ct * it) > 0) || (D = -D),
                    (B = rt * It + lt * Vt + ct * Lt) < 0 && (B = -B),
                    (F = rt * St + lt * Pt + ct * Tt) < 0 && (F = -F),
                    (q = rt * At + lt * jt + ct * Ct) < 0 && (q = -q),
                    !(
                        (z = D - (E = st) - (B * at + F * ot + q * nt)) > 0 ||
                        ((o = (D = mt * $ + pt * tt + ut * it) > 0) || (D = -D),
                        (B = mt * It + pt * Vt + ut * Lt) < 0 && (B = -B),
                        (F = mt * St + pt * Pt + ut * Tt) < 0 && (F = -F),
                        (q = mt * At + pt * jt + ut * Ct) < 0 && (q = -q),
                        (N = D - (E = ht) - (B * at + F * ot + q * nt)) > 0 ||
                            ((n = (D = yt * $ + xt * tt + dt * it) > 0) || (D = -D),
                            (B = yt * It + xt * Vt + dt * Lt) < 0 && (B = -B),
                            (F = yt * St + xt * Pt + dt * Tt) < 0 && (F = -F),
                            (q = yt * At + xt * jt + dt * Ct) < 0 && (q = -q),
                            (k = D - (E = et) - (B * at + F * ot + q * nt)) > 0 ||
                                ((r = (D = It * $ + Vt * tt + Lt * it) > 0) || (D = -D),
                                (B = It * rt + Vt * lt + Lt * ct) < 0 && (B = -B),
                                (F = It * mt + Vt * pt + Lt * ut) < 0 && (F = -F),
                                (q = It * yt + Vt * xt + Lt * dt) < 0 && (q = -q),
                                (w = 1 * (D - (E = B * st + F * ht + q * et) - at)) > 0 ||
                                    ((l = (D = St * $ + Pt * tt + Tt * it) > 0) || (D = -D),
                                    (B = St * rt + Pt * lt + Tt * ct) < 0 && (B = -B),
                                    (F = St * mt + Pt * pt + Tt * ut) < 0 && (F = -F),
                                    (q = St * yt + Pt * xt + Tt * dt) < 0 && (q = -q),
                                    (M = 1 * (D - (E = B * st + F * ht + q * et) - ot)) > 0 ||
                                        ((c = (D = At * $ + jt * tt + Ct * it) > 0) || (D = -D),
                                        (B = At * rt + jt * lt + Ct * ct) < 0 && (B = -B),
                                        (F = At * mt + jt * pt + Ct * ut) < 0 && (F = -F),
                                        (q = At * yt + jt * xt + Ct * dt) < 0 && (q = -q),
                                        (I = 1 * (D - (E = B * st + F * ht + q * et) - nt)) > 0)))))
                    ))
                ) {
                    if ((D = Jt * Jt + Wt * Wt + Ht * Ht) > 1e-5) {
                        if (
                            ((m = (D = (Jt *= D = 1 / g.sqrt(D)) * $ + (Wt *= D) * tt + (Ht *= D) * it) > 0) || (D = -D),
                            (B = Jt * mt + Wt * pt + Ht * ut) < 0 && (B = -B),
                            (F = Jt * yt + Wt * xt + Ht * dt) < 0 && (F = -F),
                            (E = B * ht + F * et),
                            (B = Jt * St + Wt * Pt + Ht * Tt) < 0 && (B = -B),
                            (F = Jt * At + Wt * jt + Ht * Ct) < 0 && (F = -F),
                            (V = D - E - (B * ot + F * nt)) > 0)
                        )
                            return;
                    } else (m = !1), (V = 0), (fi = !0);
                    if ((D = Qt * Qt + Xt * Xt + Yt * Yt) > 1e-5) {
                        if (
                            ((p = (D = (Qt *= D = 1 / g.sqrt(D)) * $ + (Xt *= D) * tt + (Yt *= D) * it) > 0) || (D = -D),
                            (B = Qt * mt + Xt * pt + Yt * ut) < 0 && (B = -B),
                            (F = Qt * yt + Xt * xt + Yt * dt) < 0 && (F = -F),
                            (E = B * ht + F * et),
                            (B = Qt * It + Xt * Vt + Yt * Lt) < 0 && (B = -B),
                            (F = Qt * At + Xt * jt + Yt * Ct) < 0 && (F = -F),
                            (L = D - E - (B * at + F * nt)) > 0)
                        )
                            return;
                    } else (p = !1), (L = 0), (bi = !0);
                    if ((D = Zt * Zt + Kt * Kt + Gt * Gt) > 1e-5) {
                        if (
                            ((u = (D = (Zt *= D = 1 / g.sqrt(D)) * $ + (Kt *= D) * tt + (Gt *= D) * it) > 0) || (D = -D),
                            (B = Zt * mt + Kt * pt + Gt * ut) < 0 && (B = -B),
                            (F = Zt * yt + Kt * xt + Gt * dt) < 0 && (F = -F),
                            (E = B * ht + F * et),
                            (B = Zt * It + Kt * Vt + Gt * Lt) < 0 && (B = -B),
                            (F = Zt * St + Kt * Pt + Gt * Tt) < 0 && (F = -F),
                            (S = D - E - (B * at + F * ot)) > 0)
                        )
                            return;
                    } else (u = !1), (S = 0), (vi = !0);
                    if ((D = $t * $t + ti * ti + ii * ii) > 1e-5) {
                        if (
                            ((y = (D = ($t *= D = 1 / g.sqrt(D)) * $ + (ti *= D) * tt + (ii *= D) * it) > 0) || (D = -D),
                            (B = $t * rt + ti * lt + ii * ct) < 0 && (B = -B),
                            (F = $t * yt + ti * xt + ii * dt) < 0 && (F = -F),
                            (E = B * st + F * et),
                            (B = $t * St + ti * Pt + ii * Tt) < 0 && (B = -B),
                            (F = $t * At + ti * jt + ii * Ct) < 0 && (F = -F),
                            (P = D - E - (B * ot + F * nt)) > 0)
                        )
                            return;
                    } else (y = !1), (P = 0), (zi = !0);
                    if ((D = si * si + hi * hi + ei * ei) > 1e-5) {
                        if (
                            ((x = (D = (si *= D = 1 / g.sqrt(D)) * $ + (hi *= D) * tt + (ei *= D) * it) > 0) || (D = -D),
                            (B = si * rt + hi * lt + ei * ct) < 0 && (B = -B),
                            (F = si * yt + hi * xt + ei * dt) < 0 && (F = -F),
                            (E = B * st + F * et),
                            (B = si * It + hi * Vt + ei * Lt) < 0 && (B = -B),
                            (F = si * At + hi * jt + ei * Ct) < 0 && (F = -F),
                            (T = D - E - (B * at + F * nt)) > 0)
                        )
                            return;
                    } else (x = !1), (T = 0), (Ni = !0);
                    if ((D = ai * ai + oi * oi + ni * ni) > 1e-5) {
                        if (
                            ((d = (D = (ai *= D = 1 / g.sqrt(D)) * $ + (oi *= D) * tt + (ni *= D) * it) > 0) || (D = -D),
                            (B = ai * rt + oi * lt + ni * ct) < 0 && (B = -B),
                            (F = ai * yt + oi * xt + ni * dt) < 0 && (F = -F),
                            (E = B * st + F * et),
                            (B = ai * It + oi * Vt + ni * Lt) < 0 && (B = -B),
                            (F = ai * St + oi * Pt + ni * Tt) < 0 && (F = -F),
                            (A = D - E - (B * at + F * ot)) > 0)
                        )
                            return;
                    } else (d = !1), (A = 0), (ki = !0);
                    if ((D = ri * ri + li * li + ci * ci) > 1e-5) {
                        if (
                            ((f = (D = (ri *= D = 1 / g.sqrt(D)) * $ + (li *= D) * tt + (ci *= D) * it) > 0) || (D = -D),
                            (B = ri * rt + li * lt + ci * ct) < 0 && (B = -B),
                            (F = ri * mt + li * pt + ci * ut) < 0 && (F = -F),
                            (E = B * st + F * ht),
                            (B = ri * St + li * Pt + ci * Tt) < 0 && (B = -B),
                            (F = ri * At + li * jt + ci * Ct) < 0 && (F = -F),
                            (j = D - E - (B * ot + F * nt)) > 0)
                        )
                            return;
                    } else (f = !1), (j = 0), (wi = !0);
                    if ((D = mi * mi + pi * pi + ui * ui) > 1e-5) {
                        if (
                            ((b = (D = (mi *= D = 1 / g.sqrt(D)) * $ + (pi *= D) * tt + (ui *= D) * it) > 0) || (D = -D),
                            (B = mi * rt + pi * lt + ui * ct) < 0 && (B = -B),
                            (F = mi * mt + pi * pt + ui * ut) < 0 && (F = -F),
                            (E = B * st + F * ht),
                            (B = mi * It + pi * Vt + ui * Lt) < 0 && (B = -B),
                            (F = mi * At + pi * jt + ui * Ct) < 0 && (F = -F),
                            (C = D - E - (B * at + F * nt)) > 0)
                        )
                            return;
                    } else (b = !1), (C = 0), (Mi = !0);
                    if ((D = yi * yi + xi * xi + di * di) > 1e-5) {
                        if (
                            ((v = (D = (yi *= D = 1 / g.sqrt(D)) * $ + (xi *= D) * tt + (di *= D) * it) > 0) || (D = -D),
                            (B = yi * rt + xi * lt + di * ct) < 0 && (B = -B),
                            (F = yi * mt + xi * pt + di * ut) < 0 && (F = -F),
                            (E = B * st + F * ht),
                            (B = yi * It + xi * Vt + di * Lt) < 0 && (B = -B),
                            (F = yi * St + xi * Pt + di * Tt) < 0 && (F = -F),
                            (O = D - E - (B * at + F * ot)) > 0)
                        )
                            return;
                    } else (v = !1), (O = 0), (gi = !0);
                    var Ii = z,
                        ...
                        Li = 0,
                        Si = a;
                    N > Vi && ((Ii = N), (Vi = N), (Li = 1), (Si = o)),
                        k > Vi && ((Ii = k), (Vi = k), (Li = 2), (Si = n)),
                        w > Vi && ((Ii = w), (Vi = w), (Li = 3), (Si = r)),
                        M > Vi && ((Ii = M), (Vi = M), (Li = 4), (Si = l)),
                        I > Vi && ((Ii = I), (Vi = I), (Li = 5), (Si = c)),
                        V - 0.01 > Vi && !fi && ((Ii = V), (Vi = V - 0.01), (Li = 6), (Si = m)),
                        L - 0.01 > Vi && !bi && ((Ii = L), (Vi = L - 0.01), (Li = 7), (Si = p)),
                        S - 0.01 > Vi && !vi && ((Ii = S), (Vi = S - 0.01), (Li = 8), (Si = u)),
                        P - 0.01 > Vi && !zi && ((Ii = P), (Vi = P - 0.01), (Li = 9), (Si = y)),
                        T - 0.01 > Vi && !Ni && ((Ii = T), (Vi = T - 0.01), (Li = 10), (Si = x)),
                        A - 0.01 > Vi && !ki && ((Ii = A), (Vi = A - 0.01), (Li = 11), (Si = d)),
                        j - 0.01 > Vi && !wi && ((Ii = j), (Vi = j - 0.01), (Li = 12), (Si = f)),
                        C - 0.01 > Vi && !Mi && ((Ii = C), (Vi = C - 0.01), (Li = 13), (Si = b)),
                        O - 0.01 > Vi && !gi && ((Ii = O), (Li = 14), (Si = v));
                    var Pi = 0,
                        Ti = 0,
                        Ai = 0,
                        ji = 0,
                    ...
                    if (
                        (0 == Li
                            ? (Si
                                  ? ((Fi = Q + ft), (qi = X + bt), (Ui = Y + vt), (Pi = rt), (Ti = lt), (Ai = ct))
                                  : ((Fi = Q - ft), (qi = X - bt), (Ui = Y - vt), (Pi = -rt), (Ti = -lt), (Ai = -ct)),
                              (Ri = zt),
                              (_i = Nt),
                              (Ji = kt),
                            ...
                            : 1 == Li
                            ? (Si
                                  ? ((Fi = Q + zt), (qi = X + Nt), (Ui = Y + kt), (Pi = mt), (Ti = pt), (Ai = ut))
                                  : ((Fi = Q - zt), (qi = X - Nt), (Ui = Y - kt), (Pi = -mt), (Ti = -pt), (Ai = -ut)),
                              (Ri = ft),
                              (_i = bt),
                              (Ji = vt),
                            ...
                            ? ((Xi = !0),
                              Si
                                  ? ((Fi = Z - Ot), (qi = K - Dt), (Ui = G - Et), (Pi = -It), (Ti = -Vt), (Ai = -Lt))
                                  : ((Fi = Z + Ot), (qi = K + Dt), (Ui = G + Et), (Pi = It), (Ti = Vt), (Ai = Lt)),
                              (Ri = Bt),
                              (_i = Ft),
                              (Ji = qt),
                            ...
                            ? ((Xi = !0),
                              Si
                                  ? ((Fi = Z - Bt), (qi = K - Ft), (Ui = G - qt), (Pi = -St), (Ti = -Pt), (Ai = -Tt))
                                  : ((Fi = Z + Bt), (qi = K + Ft), (Ui = G + qt), (Pi = St), (Ti = Pt), (Ai = Tt)),
                              (Ri = Ot),
                              (_i = Dt),
                              (Ji = Et),
                            ...
                            ? ((Xi = !0),
                              Si
                                  ? ((Fi = Z - Ut), (qi = K - Rt), (Ui = G - _t), (Pi = -At), (Ti = -jt), (Ai = -Ct))
                                  : ((Fi = Z + Ut), (qi = K + Rt), (Ui = G + _t), (Pi = At), (Ti = jt), (Ai = Ct)),
                              (Ri = Ot),
                              (_i = Dt),
                              (Ji = Et),
                              ...
                              (Bi = -Tt))
                            : 6 == Li
                            ? ((Pi = Jt), (Ti = Wt), (Ai = Ht), (ji = rt), (Ci = lt), (Oi = ct), (Di = It), (Ei = Vt), (Bi = Lt))
                            : 7 == Li
                            ? ((Pi = Qt), (Ti = Xt), (Ai = Yt), (ji = rt), (Ci = lt), (Oi = ct), (Di = St), (Ei = Pt), (Bi = Tt))
                            : 8 == Li
                            ? ((Pi = Zt), (Ti = Kt), (Ai = Gt), (ji = rt), (Ci = lt), (Oi = ct), (Di = At), (Ei = jt), (Bi = Ct))
                            : 9 == Li
                            ? ((Pi = $t), (Ti = ti), (Ai = ii), (ji = mt), (Ci = pt), (Oi = ut), (Di = It), (Ei = Vt), (Bi = Lt))
                            : 10 == Li
                            ? ((Pi = si), (Ti = hi), (Ai = ei), (ji = mt), (Ci = pt), (Oi = ut), (Di = St), (Ei = Pt), (Bi = Tt))
                            : 11 == Li
                            ? ((Pi = ai), (Ti = oi), (Ai = ni), (ji = mt), (Ci = pt), (Oi = ut), (Di = At), (Ei = jt), (Bi = Ct))
                            : 12 == Li
                            ? ((Pi = ri), (Ti = li), (Ai = ci), (ji = yt), (Ci = xt), (Oi = dt), (Di = It), (Ei = Vt), (Bi = Lt))
                            : 13 == Li
                            ? ((Pi = mi), (Ti = pi), (Ai = ui), (ji = yt), (Ci = xt), (Oi = dt), (Di = St), (Ei = Pt), (Bi = Tt))
                            : 14 == Li &&
                              ((Pi = yi), (Ti = xi), (Ai = di), (ji = yt), (Ci = xt), (Oi = dt), (Di = At), (Ei = jt), (Bi = Ct)),
                        Li > 5)
                    ) {
                        var Yi, Zi, Ki, Gi, $i, ts, is, ss, hs, es, as;
                        Si || ((Pi = -Pi), (Ti = -Ti), (Ai = -Ai)),
                            (Zi = Pi * (ts = U[0]) + Ti * (is = U[1]) + Ai * (ss = U[2])),
                            (Yi = Pi * (Ki = U[3]) + Ti * (Gi = U[4]) + Ai * ($i = U[5])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[6]) + Ti * (Gi = U[7]) + Ai * ($i = U[8])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[9]) + Ti * (Gi = U[10]) + Ai * ($i = U[11])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[12]) + Ti * (Gi = U[13]) + Ai * ($i = U[14])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[15]) + Ti * (Gi = U[16]) + Ai * ($i = U[17])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[18]) + Ti * (Gi = U[19]) + Ai * ($i = U[20])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Yi = Pi * (Ki = U[21]) + Ti * (Gi = U[22]) + Ai * ($i = U[23])) > Zi &&
                                ((Zi = Yi), (ts = Ki), (is = Gi), (ss = $i)),
                            (Zi = Pi * (hs = R[0]) + Ti * (es = R[1]) + Ai * (as = R[2])),
                            (Yi = Pi * (Ki = R[3]) + Ti * (Gi = R[4]) + Ai * ($i = R[5])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[6]) + Ti * (Gi = R[7]) + Ai * ($i = R[8])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[9]) + Ti * (Gi = R[10]) + Ai * ($i = R[11])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[12]) + Ti * (Gi = R[13]) + Ai * ($i = R[14])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[15]) + Ti * (Gi = R[16]) + Ai * ($i = R[17])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[18]) + Ti * (Gi = R[19]) + Ai * ($i = R[20])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i)),
                            (Yi = Pi * (Ki = R[21]) + Ti * (Gi = R[22]) + Ai * ($i = R[23])) < Zi &&
                                ((Zi = Yi), (hs = Ki), (es = Gi), (as = $i));
                        var os =
                            ((Ki = hs - ts) * (ji - Di * (B = ji * Di + Ci * Ei + Oi * Bi)) +
                                (Gi = es - is) * (Ci - Ei * B) +
                                ($i = as - ss) * (Oi - Bi * B)) /
                            (1 - B * B);
                        s.addPoint(
                        ...
                        var ns,
                            ...
                            Ps = 0;
                        Xi
                            ? ((Ss = rt * Pi + lt * Ti + ct * Ai) < Ls && ((Ls = Ss), (Ps = 0)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 1)),
                              (Ss = mt * Pi + pt * Ti + ut * Ai) < Ls && ((Ls = Ss), (Ps = 2)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 3)),
                              (Ss = yt * Pi + xt * Ti + dt * Ai) < Ls && ((Ls = Ss), (Ps = 4)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 5)),
                              0 == Ps
                                  ? ((ns = U[0]),
                                    (rs = U[1]),
                                  ...
                                  : 5 == Ps &&
                                    ...
                                    (fs = U[16]),
                                    (bs = U[17])))
                            : ((Ss = It * Pi + Vt * Ti + Lt * Ai) < Ls && ((Ls = Ss), (Ps = 0)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 1)),
                              (Ss = St * Pi + Pt * Ti + Tt * Ai) < Ls && ((Ls = Ss), (Ps = 2)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 3)),
                              (Ss = At * Pi + jt * Ti + Ct * Ai) < Ls && ((Ls = Ss), (Ps = 4)),
                              -Ss < Ls && ((Ls = -Ss), (Ps = 5)),
                              0 == Ps
                                  ? ((ns = R[0]),
                                    (rs = R[1]),
                                  ...
                                  : 5 == Ps &&
                                    ...
                                    (fs = R[16]),
                                    (bs = R[17]))),
                            (this.clipVertices1[0] = ns),
                            (this.clipVertices1[1] = rs),
                            (this.clipVertices1[2] = ls),
                            (this.clipVertices1[3] = cs),
                            (this.clipVertices1[4] = ms),
                            (this.clipVertices1[5] = ps),
                            (this.clipVertices1[6] = us),
                            (this.clipVertices1[7] = ys),
                            (this.clipVertices1[8] = xs),
                            (this.clipVertices1[9] = ds),
                            (this.clipVertices1[10] = fs),
                            (this.clipVertices1[11] = bs),
                            (zs = 0),
                            (B =
                                ((ks = this.clipVertices1[9]) - Fi - Ri) * ji +
                                ((ws = this.clipVertices1[10]) - qi - _i) * Ci +
                                ((Ms = this.clipVertices1[11]) - Ui - Ji) * Oi);
                        for (var Ts = 0; Ts < 4; Ts++)
                            (Ns = 3 * Ts),
                                (F =
                                    ((gs = this.clipVertices1[Ns]) - Fi - Ri) * ji +
                                    ((Is = this.clipVertices1[Ns + 1]) - qi - _i) * Ci +
                                    ((Vs = this.clipVertices1[Ns + 2]) - Ui - Ji) * Oi),
                                B > 0
                                    ? F > 0
                                        ? ((Ns = 3 * zs),
                                          zs++,
                                          (this.clipVertices2[Ns] = gs),
                                          (this.clipVertices2[Ns + 1] = Is),
                                          (this.clipVertices2[Ns + 2] = Vs))
                                        : ((Ns = 3 * zs),
                                          zs++,
                                          (os = B / (B - F)),
                                          (this.clipVertices2[Ns] = ks + (gs - ks) * os),
                                          (this.clipVertices2[Ns + 1] = ws + (Is - ws) * os),
                                          (this.clipVertices2[Ns + 2] = Ms + (Vs - Ms) * os))
                                    : F > 0 &&
                                      ((Ns = 3 * zs),
                                      zs++,
                                      (os = B / (B - F)),
                        ...
                        if (0 != (vs = zs)) {
                            for (
                                zs = 0,
                                    Ns = 3 * (vs - 1),
                                    B =
                                        ((ks = this.clipVertices2[Ns]) - Fi - Wi) * Di +
                                        ((ws = this.clipVertices2[Ns + 1]) - qi - Hi) * Ei +
                                        ((Ms = this.clipVertices2[Ns + 2]) - Ui - Qi) * Bi,
                                    Ts = 0;
                                Ts < vs;
                                Ts++
                            )
                                (Ns = 3 * Ts),
                                    (F =
                                        ((gs = this.clipVertices2[Ns]) - Fi - Wi) * Di +
                                        ((Is = this.clipVertices2[Ns + 1]) - qi - Hi) * Ei +
                                        ((Vs = this.clipVertices2[Ns + 2]) - Ui - Qi) * Bi),
                                    B > 0
                                        ? F > 0
                                            ? ((Ns = 3 * zs),
                                              zs++,
                                              (this.clipVertices1[Ns] = gs),
                                              (this.clipVertices1[Ns + 1] = Is),
                                              (this.clipVertices1[Ns + 2] = Vs))
                                            : ((Ns = 3 * zs),
                                              zs++,
                                              (os = B / (B - F)),
                                              (this.clipVertices1[Ns] = ks + (gs - ks) * os),
                                              (this.clipVertices1[Ns + 1] = ws + (Is - ws) * os),
                                              (this.clipVertices1[Ns + 2] = Ms + (Vs - Ms) * os))
                                        : F > 0 &&
                                          ((Ns = 3 * zs),
                                          zs++,
                                          (os = B / (B - F)),
                            ...
                            if (0 != (vs = zs)) {
                                for (
                                    zs = 0,
                                        Ns = 3 * (vs - 1),
                                        B =
                                            ((ks = this.clipVertices1[Ns]) - Fi + Ri) * -ji +
                                            ((ws = this.clipVertices1[Ns + 1]) - qi + _i) * -Ci +
                                            ((Ms = this.clipVertices1[Ns + 2]) - Ui + Ji) * -Oi,
                                        Ts = 0;
                                    Ts < vs;
                                    Ts++
                                )
                                ...
                                if (0 != (vs = zs)) {
                                    ...
                                    if (0 != (vs = zs)) {
                                        var js = h != t;
                                        if (vs > 4) {
                                            (ji = ns - (ks = 0.25 * (ns + cs + us + ds))),
                                                (Ci = rs - (ws = 0.25 * (rs + ms + ys + fs))),
                                                (Oi = ls - (Ms = 0.25 * (ls + ps + xs + bs))),
                                                (Di = cs - ks),
                                                (Ei = ms - ws),
                                                (Bi = ps - Ms);
                                            var Cs = 0,
                                            ...
                                            for (Ls = this.INF, Ts = 0; Ts < vs; Ts++)
                                                (this.used[Ts] = !1),
                                                    (Ns = 3 * Ts),
                                                    (Ss =
                                                        (ks = this.clipVertices1[Ns]) * ji +
                                                        (ws = this.clipVertices1[Ns + 1]) * Ci +
                                                        (Ms = this.clipVertices1[Ns + 2]) * Oi) < Ls && ((Ls = Ss), (Cs = Ts)),
                                                    Ss > Bs && ((Bs = Ss), (Ds = Ts));
                                            for (
                                                this.used[Cs] = !0, this.used[Ds] = !0, Bs = -this.INF, Ls = this.INF, Ts = 0;
                                                Ts < vs;
                                                Ts++
                                            )
                                                this.used[Ts] ||
                                                    ((Ns = 3 * Ts),
                                                    (Ss =
                                                        (ks = this.clipVertices1[Ns]) * Di +
                                                        (ws = this.clipVertices1[Ns + 1]) * Ei +
                                                        (Ms = this.clipVertices1[Ns + 2]) * Bi) < Ls && ((Ls = Ss), (Os = Ts)),
                                                    Ss > Bs && ((Bs = Ss), (Es = Ts)));
                                            (Ns = 3 * Cs),
                                                (Ss =
                                                    ((ks = this.clipVertices1[Ns]) - Fi) * Pi +
                                                    ((ws = this.clipVertices1[Ns + 1]) - qi) * Ti +
                                                    ((Ms = this.clipVertices1[Ns + 2]) - Ui) * Ai) < 0 &&
                                                    s.addPoint(ks, ws, Ms, Pi, Ti, Ai, Ss, js),
                                                (Ns = 3 * Os),
                                                (Ss =
                                                    ((ks = this.clipVertices1[Ns]) - Fi) * Pi +
                                                    ((ws = this.clipVertices1[Ns + 1]) - qi) * Ti +
        ...
        (Vt.prototype = Object.assign(Object.create(gt.prototype), {
            ...
            getSep: function (t, i, s, h, e) {
                ...
                if ((P = q * S - U * V) * P + (T = U * I - F * S) * T + (A = F * V - q * I) * A == 0)
                    return s.set(F - I, q - V, U - S).normalize(), h.set(0.5 * (j + D), 0.5 * (C + E), 0.5 * (O + B)), !0;
                this.supportPointB(t, -P, -T, -A, b);
                var R = b.x,
                    _ = b.y,
                    J = b.z;
                ...
                for (var K = 0; ; ) {
                    ...
                    if ((q * ot - U * at) * I + (U * et - F * ot) * V + (F * at - q * et) * S < 0)
                        (X = et),
                            (Y = at),
                            (Z = ot),
                            (R = G),
                            ...
                            (H = st),
                            (Q = ht),
                            (P = (o = q - V) * (c = ot - S) - (n = U - S) * (l = at - V)),
                            (T = n * (r = et - I) - (a = F - I) * c),
                            (A = a * l - o * r);
                    else if ((at * Z - ot * Y) * I + (ot * X - et * Z) * V + (et * Y - at * X) * S < 0)
                        (F = et),
                            (q = at),
                            (U = ot),
                            (j = G),
                            ...
                            (E = st),
                            (B = ht),
                            (P = (o = at - V) * (c = Z - S) - (n = ot - S) * (l = Y - V)),
                            (T = n * (r = X - I) - (a = et - I) * c),
                            (A = a * l - o * r);
                    else
                        for (var nt = !1; ; ) {
                            if (
                                ((P = (o = Y - q) * (c = ot - U) - (n = Z - U) * (l = at - q)),
                                (T = n * (r = et - F) - (a = X - F) * c),
                                (A = a * l - o * r),
                                (P *= m = 1 / g.sqrt(P * P + T * T + A * A)) * F + (T *= m) * q + (A *= m) * U >= 0 && !nt)
                            ) {
                                ...
                                pt <= 0 &&
                                    ((rt = 0),
                                    (pt =
                                        (lt = (Y * ot - Z * at) * P + (Z * et - X * ot) * T + (X * at - Y * et) * A) +
                                        (ct = (at * Z - ot * Y) * P + (ot * X - et * Z) * T + (et * Y - at * X) * A) +
                                        (mt = (q * Z - U * Y) * P + (U * X - F * Z) * T + (F * Y - q * X) * A)));
                                var ut = 1 / pt;
                                (p = (v * rt + j * lt + R * ct + G * mt) * ut),
                                    (u = (z * rt + C * lt + _ * ct + $ * mt) * ut),
                                    (y = (N * rt + O * lt + J * ct + tt * mt) * ut),
                                    (x = (k * rt + D * lt + W * ct + it * mt) * ut),
                                    (d = (w * rt + E * lt + H * ct + st * mt) * ut),
                                    (f = (M * rt + B * lt + Q * ct + ht * mt) * ut),
                                    (nt = !0);
                            }
                            this.supportPointB(t, -P, -T, -A, b);
                            var yt = b.x,
                            ...
                            var ft = b.x,
                                ...
                                kt = vt - dt,
                                wt = -(zt * P + Nt * T + kt * A);
                            if ((zt - et) * P + (Nt - at) * T + (kt - ot) * A <= 0.01 || wt >= 0)
                                return !!nt && (s.set(-P, -T, -A), h.set(0.5 * (p + x), 0.5 * (u + d), 0.5 * (y + f)), (e.x = wt), !0);
                            (Nt * U - kt * q) * I + (kt * F - zt * U) * V + (zt * q - Nt * F) * S < 0
                                ? (Nt * Z - kt * Y) * I + (kt * X - zt * Z) * V + (zt * Y - Nt * X) * S < 0
                                    ? ((F = zt), (q = Nt), (U = kt), (j = yt), (C = xt), (O = dt), (D = ft), (E = bt), (B = vt))
                                    : ((et = zt), (at = Nt), (ot = kt), (G = yt), ($ = xt), (tt = dt), (it = ft), (st = bt), (ht = vt))
                                : (Nt * ot - kt * at) * I + (kt * et - zt * ot) * V + (zt * at - Nt * et) * S < 0
                                ? ((X = zt), (Y = Nt), (Z = kt), (R = yt), (_ = xt), (J = dt), (W = ft), (H = bt), (Q = vt))
                                : ((F = zt), (q = Nt), (U = kt), (j = yt), (C = xt), (O = dt), (D = ft), (E = bt), (B = vt));
                        }
                }
            },
            supportPointB: function (t, i, s, h, e) {
                ...
                (a = l < 0 ? -p : p),
                    (o = c < 0 ? -u : u),
                    (n = m < 0 ? -y : y),
                    (l = r[0] * a + r[1] * o + r[2] * n + t.position.x),
                    (c = r[3] * a + r[4] * o + r[5] * n + t.position.y),
                    (m = r[6] * a + r[7] * o + r[8] * n + t.position.z),
                    e.set(l, c, m);
            },
            supportPointC: function (t, i, s, h, e) {
                ...
                0 == y
                    ? c < 0
                        ? ((a = x), (o = -d), (n = 0))
                        : ((a = x), (o = d), (n = 0))
                    : ((y = t.radius / g.sqrt(y)), c < 0 ? ((a = p * y), (o = -d), (n = u * y)) : ((a = p * y), (o = d), (n = u * y))),
                    (l = r[0] * a + r[1] * o + r[2] * n + t.position.x),
                    (c = r[3] * a + r[4] * o + r[5] * n + t.position.y),
                    (m = r[6] * a + r[7] * o + r[8] * n + t.position.z),
                    e.set(l, c, m);
            ...
            detectCollision: function (t, i, s) {
                ...
                if (this.getSep(h, e, a, o, n)) {
                    ...
                    if (
                        (G > 0.999
                            ? (si = Y > 0.999 ? (Y > G ? 1 : 4) : Z > 0.999 ? (Z > G ? 2 : 4) : K > 0.999 && K > G ? 3 : 4)
                            : Y > 0.999
                            ? (si = 1)
                            : Z > 0.999
                            ? (si = 2)
                        ...
                        s.addPoint(o.x, o.y, o.z, H, Q, X, n.x, this.flip);
                    else if (4 == si) {
                        var hi, ei, ai, oi, ni, ri, li, ci, mi, pi, ui, yi;
                        st
                            ? ((ot = m - _), (nt = p - J), (rt = u - W), (H = -q), (Q = -U), (X = -R))
                            : ((ot = m + _), (nt = p + J), (rt = u + W), (H = q), (Q = U), (X = R)),
                            (si = 0),
                            (Wt = z * H + N * Q + k * X) < (kt = 1) && ((kt = Wt), (si = 0)),
                            -Wt < kt && ((kt = -Wt), (si = 1)),
                            (Wt = w * H + M * Q + I * X) < kt && ((kt = Wt), (si = 2)),
                            -Wt < kt && ((kt = -Wt), (si = 3)),
                            (Wt = V * H + S * Q + P * X) < kt && ((kt = Wt), (si = 4)),
                            -Wt < kt && ((kt = -Wt), (si = 5));
                        var xi = h.elements;
                        switch (si) {
                            case 0:
                        ...
                        (Nt = H * (hi - ot) + Q * (ei - nt) + X * (ai - rt)) <= 0 && s.addPoint(hi, ei, ai, -H, -Q, -X, Nt, this.flip),
                            (Nt = H * (oi - ot) + Q * (ni - nt) + X * (ri - rt)) <= 0 && s.addPoint(oi, ni, ri, -H, -Q, -X, Nt, this.flip),
                            (Nt = H * (li - ot) + Q * (ci - nt) + X * (mi - rt)) <= 0 && s.addPoint(li, ci, mi, -H, -Q, -X, Nt, this.flip),
                            (Nt = H * (pi - ot) + Q * (ui - nt) + X * (yi - rt)) <= 0 && s.addPoint(pi, ui, yi, -H, -Q, -X, Nt, this.flip);
                    } else {
                        switch (si) {
                            case 1:
                                $
                                    ? ((ht = r + T), (et = l + A), (at = c + j), (H = z), (Q = N), (X = k))
                                    : ((ht = r - T), (et = l - A), (at = c - j), (H = -z), (Q = -N), (X = -k)),
                                    (Xt = w),
                                    (Yt = M),
                                    (Zt = I),
                            ...
                            case 2:
                                tt
                                    ? ((ht = r + C), (et = l + O), (at = c + D), (H = w), (Q = M), (X = I))
                                    : ((ht = r - C), (et = l - O), (at = c - D), (H = -w), (Q = -M), (X = -I)),
                                    (Xt = z),
                                    (Yt = N),
                                    (Zt = k),
                            ...
                            case 3:
                                it
                                    ? ((ht = r + E), (et = l + B), (at = c + F), (H = V), (Q = S), (X = P))
                                    : ((ht = r - E), (et = l - B), (at = c - F), (H = -V), (Q = -S), (X = -P)),
                                    (Xt = z),
                                    (Yt = N),
                                    (Zt = k),
                        ...
                        if (
                            ((ot = m + (wt = (kt = H * q + Q * U + X * R) < 0 ? f : -f) * q),
                            (nt = p + wt * U),
                            (rt = u + wt * R),
                            G >= 0.999999 ? ((Mt = -Q), (gt = X), (It = H)) : ((Mt = H), (gt = Q), (It = X)),
                            (Lt = (wt = Mt * q + gt * U + It * R) * q - Mt),
                            (St = wt * U - gt),
                            (Pt = wt * R - It),
                            0 == (wt = g.sqrt(Lt * Lt + St * St + Pt * Pt)))
                        )
                            return;
                        if (((Mt = ot + (Lt *= wt = b / wt)), (gt = nt + (St *= wt)), (It = rt + (Pt *= wt)), kt < -0.96 || kt > 0.96))
                            (lt = q * q * 1.5 - 0.5),
                                (ct = q * U * 1.5 - 0.866025403 * R),
                                (mt = q * R * 1.5 + 0.866025403 * U),
                                (pt = U * q * 1.5 + 0.866025403 * R),
                                (ut = U * U * 1.5 - 0.5),
                                (yt = U * R * 1.5 - 0.866025403 * q),
                                (xt = R * q * 1.5 - 0.866025403 * U),
                                (dt = R * U * 1.5 + 0.866025403 * q),
                                (ft = R * R * 1.5 - 0.5),
                                (qt =
                                    Xt * (Mt = (bt = Mt) - (Nt = H * (bt - ht) + Q * ((vt = gt) - et) + X * ((zt = It) - at)) * H - ht) +
                                    Yt * (gt = vt - Nt * Q - et) +
                                    Zt * (It = zt - Nt * X - at)) < -ti
                                    ? (qt = -ti)
                                    : qt > ti && (qt = ti),
                                (Jt = Kt * Mt + Gt * gt + $t * It) < -ii ? (Jt = -ii) : Jt > ii && (Jt = ii),
                                (bt = ht + (Mt = qt * Xt + Jt * Kt)),
                                (vt = et + (gt = qt * Yt + Jt * Gt)),
                                (zt = at + (It = qt * Zt + Jt * $t)),
                                s.addPoint(bt, vt, zt, H, Q, X, Nt, this.flip),
                                (vt = Lt * pt + St * ut + Pt * yt),
                                (zt = Lt * xt + St * dt + Pt * ft),
                                (Nt =
                                    H * ((bt = (Lt = bt = Lt * lt + St * ct + Pt * mt) + ot) - ht) +
                                    Q * ((vt = (St = vt) + nt) - et) +
                                    X * ((zt = (Pt = zt) + rt) - at)) <= 0 &&
                                    ((qt = Xt * (Mt = bt - Nt * H - ht) + Yt * (gt = vt - Nt * Q - et) + Zt * (It = zt - Nt * X - at)) < -ti
                                        ? (qt = -ti)
                                        : qt > ti && (qt = ti),
                                    (Jt = Kt * Mt + Gt * gt + $t * It) < -ii ? (Jt = -ii) : Jt > ii && (Jt = ii),
                                    (bt = ht + (Mt = qt * Xt + Jt * Kt)),
                            ...
                            if (
                                ((Et = Mt),
                                kt > 0
                                    ? ((Ut = Mt + 2 * _), (Rt = gt + 2 * J), (_t = It + 2 * W))
                                    : ((Ut = Mt - 2 * _), (Rt = gt - 2 * J), (_t = It - 2 * W)),
                                (Mt =
                                    (Ut -= (Jt = H * (Ut - ht) + Q * (Rt - et) + X * (_t - at)) * H) -
                                    (Et -= (qt = H * (Et - ht) + Q * ((Bt = gt) - et) + X * ((Ft = It) - at)) * H)),
                                (gt = (Rt -= Jt * Q) - (Bt -= qt * Q)),
                                (It = (_t -= Jt * X) - (Ft -= qt * X)),
                                (Vt = Jt - qt),
                                (Ht = (Z = (Ct = Ut - ht) * Xt + (Ot = Rt - et) * Yt + (Dt = _t - at) * Zt) - ti),
                                (Wt = (Y = (Tt = Et - ht) * Xt + (At = Bt - et) * Yt + (jt = Ft - at) * Zt) - ti) > 0)
                            ) {
                                if (Ht > 0) return;
                                (Y =
                                    (Tt = (Et += Mt * (Qt = Wt / (Wt - Ht))) - ht) * Xt +
                                    (At = (Bt += gt * Qt) - et) * Yt +
                                    (jt = (Ft += It * Qt) - at) * Zt),
                                    (Mt = Ut - Et),
                                    (gt = Rt - Bt),
                                ...
                                Ht > 0 &&
                                    ((Z =
                                        (Ct = (Ut = Et + Mt * (Qt = Wt / (Wt - Ht))) - ht) * Xt +
                                        (Ot = (Rt = Bt + gt * Qt) - et) * Yt +
                                        (Dt = (_t = Ft + It * Qt) - at) * Zt),
                                    (Mt = Ut - Et),
                                    (gt = Rt - Bt),
                                    (It = _t - Ft),
                                    (Vt = (Jt = qt + Vt * Qt) - qt));
                            ...
                            if (((Ht = (Z = Ct * Kt + Ot * Gt + Dt * $t) - ii), (Wt = (Y = Tt * Kt + At * Gt + jt * $t) - ii) > 0)) {
                                ...
                                Ht > 0 &&
                                    ((Z =
                                        (Ct = (Ut = Et + Mt * (Qt = Wt / (Wt - Ht))) - ht) * Kt +
                                        (Ot = (Rt = Bt + gt * Qt) - et) * Gt +
                                        (Dt = (_t = Ft + It * Qt) - at) * $t),
                                    (Mt = Ut - Et),
                                    (gt = Rt - Bt),
                                    (It = _t - Ft),
                            ...
                            if (((Ht = Z + ii), (Wt = Y + ii) < 0)) {
                                ...
                                Ht < 0 &&
                                    ((Ut = Et + Mt * (Qt = Wt / (Wt - Ht))), (Rt = Bt + gt * Qt), (_t = Ft + It * Qt), (Jt = qt + Vt * Qt));
                            qt < 0 && s.addPoint(Et, Bt, Ft, H, Q, X, qt, this.flip),
                                Jt < 0 && s.addPoint(Ut, Rt, _t, H, Q, X, Jt, this.flip);
                        }
                    }
                }
            },
            ...
            detectCollision: function (t, i, s) {
                ...
                if (this.getSep(h, e, at, ot, nt)) {
                    ...
                    var pt,
                        ...
                        yt,
                        xt = 0;
                    (rt > 0.999 || lt > 0.999) && (xt = rt > lt ? 1 : 2);
                    var dt,
                        ft,
                        bt,
                        vt,
                    ...
                    switch (((pt = at.x), (ut = at.y), (yt = at.z), xt)) {
                        ...
                        case 1:
                            if (
                                (ct
                                    ? ((o = P + Z), (n = T + K), (r = A + G), (pt = J), (ut = W), (yt = H))
                                    : ((o = P - Z), (n = T - K), (r = A - G), (pt = -J), (ut = -W), (yt = -H)),
                                (l = j + (a = (w = pt * Q + ut * X + yt * Y) < 0 ? E : -E) * Q),
                                (c = C + a * X),
                                (m = O + a * Y),
                                lt >= 0.999999 ? ((p = -ut), (u = yt), (y = pt)) : ((p = pt), (u = ut), (y = yt)),
                                (st = (a = p * Q + u * X + y * Y) * Q - p),
                                (ht = a * X - u),
                                (et = a * Y - y),
                                0 == (a = g.sqrt(st * st + ht * ht + et * et)))
                            )
                                break;
                            if (((p = l + (st *= a = _ / a)), (u = c + (ht *= a)), (y = m + (et *= a)), w < -0.96 || w > 0.96))
                                (dt = Q * Q * 1.5 - 0.5),
                                    (ft = Q * X * 1.5 - 0.866025403 * Y),
                                    (bt = Q * Y * 1.5 + 0.866025403 * X),
                                    (vt = X * Q * 1.5 + 0.866025403 * Y),
                                    (zt = X * X * 1.5 - 0.5),
                                    (Nt = X * Y * 1.5 - 0.866025403 * Q),
                                    (kt = Y * Q * 1.5 - 0.866025403 * X),
                                    (wt = Y * X * 1.5 + 0.866025403 * Q),
                                    (Mt = Y * Y * 1.5 - 0.5),
                                    (a =
                                        (p = (gt = p) - (Lt = pt * (gt - o) + ut * ((It = u) - n) + yt * ((Vt = y) - r)) * pt - o) * p +
                                        (u = It - Lt * ut - n) * u +
                                        (y = Vt - Lt * yt - r) * y) >
                                        R * R && ((p *= a = R / g.sqrt(a)), (u *= a), (y *= a)),
                                    (gt = o + p),
                                    (It = n + u),
                                    (Vt = r + y),
                                    s.addPoint(gt, It, Vt, pt, ut, yt, Lt, !1),
                                    (It = st * vt + ht * zt + et * Nt),
                                    (Vt = st * kt + ht * wt + et * Mt),
                                    (Lt =
                                        pt * ((gt = (st = gt = st * dt + ht * ft + et * bt) + l) - o) +
                                        ut * ((It = (ht = It) + c) - n) +
                                        yt * ((Vt = (et = Vt) + m) - r)) <= 0 &&
                                        ((a = (p = gt - Lt * pt - o) * p + (u = It - Lt * ut - n) * u + (y = Vt - Lt * yt - r) * y) >
                                            R * R && ((p *= a = R / g.sqrt(a)), (u *= a), (y *= a)),
                                        (gt = o + p),
                                        (It = n + u),
                                        (Vt = r + y),
                                ...
                                if (
                                    ((x = p),
                                    w > 0
                                        ? ((b = p + Q * E * 2), (v = u + X * E * 2), (z = y + Y * E * 2))
                                        : ((b = p - Q * E * 2), (v = u - X * E * 2), (z = y - Y * E * 2)),
                                    (Tt =
                                        (St =
                                            (st = o - (x -= (N = pt * (x - o) + ut * ((d = u) - n) + yt * ((f = y) - r)) * pt)) *
                                                (p = (b -= (k = pt * (b - o) + ut * (v - n) + yt * (z - r)) * pt) - x) +
                                            (ht = n - (d -= N * ut)) * (u = (v -= k * ut) - d) +
                                            (et = r - (f -= N * yt)) * (y = (z -= k * yt) - f)) *
                                            St -
                                        (Pt = p * p + u * u + y * y) * (st * st + ht * ht + et * et - R * R)) < 0)
                                )
                                    break;
                                (I = (St - (Tt = g.sqrt(Tt))) / Pt) < (M = (St + Tt) / Pt) && ((a = M), (M = I), (I = a)),
                                    I > 1 && (I = 1),
                                    M < 0 && (M = 0),
                                    (p = x + (b - x) * M),
                                    (u = d + (v - d) * M),
                                    ...
                                    (a = N + (k - N) * M),
                                    (k = N + (k - N) * I),
                                    (N = a) < 0 && s.addPoint(x, d, f, pt, ut, yt, Lt, !1),
                                    k < 0 && s.addPoint(b, v, z, pt, ut, yt, Lt, !1);
                            }
                            break;
                        case 2:
                            if (
                                (mt
                                    ? ((l = j - $), (c = C - tt), (m = O - it), (pt = -Q), (ut = -X), (yt = -Y))
                                    : ((l = j + $), (c = C + tt), (m = O + it), (pt = Q), (ut = X), (yt = Y)),
                                (o = P + (a = (w = pt * J + ut * W + yt * H) < 0 ? D : -D) * J),
                                (n = T + a * W),
                                (r = A + a * H),
                                rt >= 0.999999 ? ((p = -ut), (u = yt), (y = pt)) : ((p = pt), (u = ut), (y = yt)),
                                (st = (a = p * J + u * W + y * H) * J - p),
                                (ht = a * W - u),
                                (et = a * H - y),
                                0 == (a = g.sqrt(st * st + ht * ht + et * et)))
                            )
                                break;
                            if (((p = o + (st *= a = R / a)), (u = n + (ht *= a)), (y = r + (et *= a)), w < -0.96 || w > 0.96))
                                (dt = J * J * 1.5 - 0.5),
                                    (ft = J * W * 1.5 - 0.866025403 * H),
                                    (bt = J * H * 1.5 + 0.866025403 * W),
                                    (vt = W * J * 1.5 + 0.866025403 * H),
                                    (zt = W * W * 1.5 - 0.5),
                                    (Nt = W * H * 1.5 - 0.866025403 * J),
                                    (kt = H * J * 1.5 - 0.866025403 * W),
                                    (wt = H * W * 1.5 + 0.866025403 * J),
                                    (Mt = H * H * 1.5 - 0.5),
                                    (a =
                                        (p = (gt = p) - (Lt = pt * (gt - l) + ut * ((It = u) - c) + yt * ((Vt = y) - m)) * pt - l) * p +
                                        (u = It - Lt * ut - c) * u +
                                        (y = Vt - Lt * yt - m) * y) >
                                        _ * _ && ((p *= a = _ / g.sqrt(a)), (u *= a), (y *= a)),
                                    (gt = l + p),
                                    (It = c + u),
                                    (Vt = m + y),
                                    s.addPoint(gt, It, Vt, -pt, -ut, -yt, Lt, !1),
                                    ...
                                    (Vt = st * kt + ht * wt + et * Mt),
                                    (Lt =
                                        pt * ((gt = (st = gt = st * dt + ht * ft + et * bt) + o) - l) +
                                        ut * ((It = (ht = It) + n) - c) +
                                        yt * ((Vt = (et = Vt) + r) - m)) <= 0 &&
                                        ((a = (p = gt - Lt * pt - l) * p + (u = It - Lt * ut - c) * u + (y = Vt - Lt * yt - m) * y) >
                                            _ * _ && ((p *= a = _ / g.sqrt(a)), (u *= a), (y *= a)),
                                        (gt = l + p),
                                        (It = c + u),
                                        (Vt = m + y),
                                ...
                                if (
                                    ((x = p),
                                    w > 0
                                        ? ((b = p + J * D * 2), (v = u + W * D * 2), (z = y + H * D * 2))
                                        : ((b = p - J * D * 2), (v = u - W * D * 2), (z = y - H * D * 2)),
                                    (Tt =
                                        (St =
                                            (st = l - (x -= (N = pt * (x - l) + ut * ((d = u) - c) + yt * ((f = y) - m)) * pt)) *
                                                (p = (b -= (k = pt * (b - l) + ut * (v - c) + yt * (z - m)) * pt) - x) +
                                            (ht = c - (d -= N * ut)) * (u = (v -= k * ut) - d) +
                                            (et = m - (f -= N * yt)) * (y = (z -= k * yt) - f)) *
                                            St -
                                        (Pt = p * p + u * u + y * y) * (st * st + ht * ht + et * et - _ * _)) < 0)
                                )
                                    break;
                                (I = (St - (Tt = g.sqrt(Tt))) / Pt) < (M = (St + Tt) / Pt) && ((a = M), (M = I), (I = a)),
                                    I > 1 && (I = 1),
                                    ...
                                    (a = N + (k - N) * M),
                                    (k = N + (k - N) * I),
                                    (N = a) < 0 && s.addPoint(x, d, f, -pt, -ut, -yt, N, !1),
                                    k < 0 && s.addPoint(b, v, z, -pt, -ut, -yt, k, !1);
                            }
                    }
                }
            },
        ...
        (St.prototype = Object.assign(Object.create(gt.prototype), {
            ...
            detectCollision: function (t, i, s) {
                ...
                V > z ? (V = z) : V < -z ? (V = -z) : (P = 1),
                    ...
                    7 == P
                        ? ((I = S < 0 ? k + S : k - S),
                          (w = V < 0 ? z + V : z - V) < (M = L < 0 ? N + L : N - L)
                              ? w < I
                                  ? ((r = w - z),
                                    V < 0
                                        ? ((V = -z), (w = c[0]), (M = c[1]), (I = c[2]))
                                        : ((V = z), (w = -c[0]), (M = -c[1]), (I = -c[2])))
                                  : ((r = I - k),
                                    S < 0
                                        ? ((S = -k), (w = c[6]), (M = c[7]), (I = c[8]))
                                        : ((S = k), (w = -c[6]), (M = -c[7]), (I = -c[8])))
                              : M < I
                              ? ((r = M - N),
                                L < 0 ? ((L = -N), (w = c[3]), (M = c[4]), (I = c[5])) : ((L = N), (w = -c[3]), (M = -c[4]), (I = -c[5])))
                              : ((r = I - k),
                                S < 0 ? ((S = -k), (w = c[6]), (M = c[7]), (I = c[8])) : ((S = k), (w = -c[6]), (M = -c[7]), (I = -c[8]))),
                          (a = d + V * c[0] + L * c[3] + S * c[6]),
                          (o = f + V * c[1] + L * c[4] + S * c[7]),
                          (n = b + V * c[2] + L * c[5] + S * c[8]),
                          s.addPoint(p + v * w, u + v * M, y + v * I, w, M, I, r - v, this.flip))
                        : ((a = d + V * c[0] + L * c[3] + S * c[6]),
                          (o = f + V * c[1] + L * c[4] + S * c[7]),
                          (n = b + V * c[2] + L * c[5] + S * c[8]),
                          (r = (w = a - m.x) * w + (M = o - m.y) * M + (I = n - m.z) * I) > 0 &&
                              r < v * v &&
                              ((w *= l = 1 / (r = g.sqrt(r))),
                              (M *= l),
                              (I *= l),
            ...
            detectCollision: function (t, i, s) {
                ...
                if (!(w < -v - d || w > v + d)) {
                    var M,
                        ...
                        A = S * S + P * P + T * T;
                    if (!(A > b * b))
                        A > f * f && ((S *= A = f / g.sqrt(A)), (P *= A), (T *= A)),
                            w < -v ? (w = -v) : w > v && (w = v),
                            (A =
                                (z = (I = c + w * u + S) - o) * z + (N = (V = m + w * y + P) - n) * N + (k = (L = p + w * x + T) - r) * k) >
                                0 &&
                                A < d * d &&
                                ((z *= M = 1 / (A = g.sqrt(A))),
                                (N *= M),
                                (k *= M),
                                s.addPoint(o + z * d, n + N * d, r + k * d, z, N, k, A - d, this.flip));
                }
            },
        })),
            ...
            detectCollision: function (t, i, s) {
                ...
                e.sub(o.position, n.position),
                    ...
                    (h = e.lengthSq()) > 0 &&
                        h < r * r &&
                        ((h = g.sqrt(h)),
                        e.copy(n.normal).negate(),
                        a.copy(o.position).addScaledVector(e, r),
                        s.addPointVec(a, e, h - r, this.flip));
            },
        })),
        (jt.prototype = Object.assign(Object.create(gt.prototype), {
            ...
            detectCollision: function (t, i, s) {
                var h,
                    ...
                    p = n.halfDepth,
                    u = 0;
                this.dix.set(l[0], l[1], l[2]),
                    this.diy.set(l[3], l[4], l[5]),
                    this.diz.set(l[6], l[7], l[8]),
                    e.sub(n.position, r.position),
                    (e.x *= r.normal.x),
                    (e.y *= r.normal.y),
                    (e.z *= r.normal.z),
                    o.set(g.dotVectors(this.dix, e), g.dotVectors(this.diy, e), g.dotVectors(this.diz, e)),
                    o.x > c ? (o.x = c) : o.x < -c ? (o.x = -c) : (u = 1),
                    o.y > m ? (o.y = m) : o.y < -m ? (o.y = -m) : (u |= 2),
                    o.z > p ? (o.z = p) : o.z < -p ? (o.z = -p) : (u |= 4),
                    7 === u &&
                        (e.set(o.x < 0 ? c + o.x : c - o.x, o.y < 0 ? m + o.y : m - o.y, o.z < 0 ? p + o.z : p - o.z),
                        e.x < e.y
                            ? e.x < e.z
                                ? ((h = e.x - c), o.x < 0 ? ((o.x = -c), e.copy(this.dix)) : ((o.x = c), e.subEqual(this.dix)))
                                : ((h = e.z - p), o.z < 0 ? ((o.z = -p), e.copy(this.diz)) : ((o.z = p), e.subEqual(this.diz)))
                            : e.y < e.z
                            ? ((h = e.y - m), o.y < 0 ? ((o.y = -m), e.copy(this.diy)) : ((o.y = m), e.subEqual(this.diy)))
                            : ((h = e.z - p), o.z < 0 ? ((o.z = -p), e.copy(this.diz)) : ((o.z = p), e.subEqual(this.diz))),
                        a.copy(r.position).addScaledVector(e, 1),
                        s.addPointVec(a, e, h, this.flip));
            },
        })),
        Object.assign(Ct.prototype, {
            World: !0,
            ...
            removeRigidBody: function (t) {
                ...
                if (i.parent === this) {
                    ...
                    null !== a && (a.next = o),
                        null !== o && (o.prev = a),
                        this.rigidBodies == i && (this.rigidBodies = o),
                        (i.prev = null),
                        (i.next = null),
                        (i.parent = null),
                        this.numRigidBodies--;
            ...
            addShape: function (t) {
                (t.parent && t.parent.parent) || I("World", "It is not possible to be added alone to shape world"),
            ...
            addJoint: function (t) {
                t.parent && I("World", "It is not possible to be added to more than one world one of the joint"),
            ...
            addContact: function (t, i) {
                ...
                null !== this.unusedContacts
                    ? ((s = this.unusedContacts), (this.unusedContacts = this.unusedContacts.next))
                    : (s = new lt()),
                    s.attach(t, i),
                    (s.detector = this.detectors[t.type][i.type]),
                    this.contacts && ((this.contacts.prev = s).next = this.contacts),
                    (this.contacts = s),
                    this.numContacts++;
            },
            removeContact: function (t) {
                ...
                s && (s.prev = i),
                    i && (i.next = s),
                    this.contacts == t && (this.contacts = s),
                    (t.prev = null),
                    (t.next = null),
                    t.detach(),
            ...
            getContact: function (t, i) {
                ...
                for (var e = this.contacts; null !== e; ) {
                    if (((s = e.body1.name), (h = e.body2.name), (s === t && h === i) || (h === t && s === i)))
                        return e.touching ? e : null;
                    e = e.next;
                }
                return null;
            },
            ...
            callSleep: function (t) {
                return !!t.allowSleep && !(t.linearVelocity.lengthSq() > 0.04) && !(t.angularVelocity.lengthSq() > 0.25);
            },
            step: function () {
                var t = this.isStat;
                ...
                for (var s = this.broadPhase.pairs, h = this.broadPhase.numPairs; h--; ) {
                    var e,
                        ...
                        o,
                        n = s[h];
                    n.shape1.id < n.shape2.id ? ((e = n.shape1), (a = n.shape2)) : ((e = n.shape2), (a = n.shape1)),
                        (o = e.numContacts < a.numContacts ? e.contactLink : a.contactLink);
                    for (var r = !1; o; ) {
                ...
                for (t && this.performance.calcBroadPhase(), this.numContactPoints = 0, z = this.contacts; null !== z; )
                    if (z.persisting || !z.shape1.aabb.intersectTest(z.shape2.aabb)) {
                        var l = z.body1,
                            c = z.body2;
                        ((l.isDynamic && !l.sleeping) || (c.isDynamic && !c.sleeping)) && z.updateManifold(),
                            (this.numContactPoints += z.manifold.numPoints),
                            (z.persisting = !1),
                            (z.constraint.addedToIsland = !1),
                            (z = z.next);
                    } else {
                        var m = z.next;
                ...
                for (var x = this.rigidBodies; null !== x; x = x.next)
                    if (!(x.addedToIsland || x.isStatic || x.sleeping))
                        if (x.isLonely())
                            x.isDynamic && x.linearVelocity.addScaledVector(this.gravity, this.timeStep),
                                this.callSleep(x)
                                    ? ((x.sleepTime += this.timeStep), x.sleepTime > 0.5 ? x.sleep() : x.updatePosition(this.timeStep))
                                    : ((x.sleepTime = 0), x.updatePosition(this.timeStep)),
                                this.numIslands++;
                        else {
                            var d = 0,
                                f = 0,
                            ...
                            do {
                                if (
                                    ((i = this.islandStack[--b]),
                                    (this.islandStack[b] = null),
                                    (i.sleeping = !1),
                                    (this.islandRigidBodies[d++] = i),
                                    !i.isStatic)
                                ) {
                                    for (var v = i.contactLink; null !== v; v = v.next) {
                                        var z;
                                        if (!(u = (z = v.contact).constraint).addedToIsland && z.touching)
                                            (this.islandConstraints[f++] = u),
                                                (u.addedToIsland = !0),
                                                (m = v.body).addedToIsland || ((this.islandStack[b++] = m), (m.addedToIsland = !0));
                                    }
                                    for (var N = i.jointLink; null !== N; N = N.next)
                                        (u = N.joint).addedToIsland ||
                                            ((this.islandConstraints[f++] = u),
                                            (u.addedToIsland = !0),
                                            !(m = N.body).addedToIsland &&
                                                m.isDynamic &&
                                                ((this.islandStack[b++] = m), (m.addedToIsland = !0)));
                                }
                            } while (0 != b);
                            ...
                            if (this.enableRandomizer)
                                for (w = f; w--; )
                                    if (0 !== w) {
                                        ...
                                        (u = this.islandConstraints[w]),
                                            (this.islandConstraints[w] = this.islandConstraints[M]),
                                            (this.islandConstraints[M] = u);
                                    }
                            for (w = f; w--; ) this.islandConstraints[w].preSolve(this.timeStep, y);
                            for (var g = this.numIterations; g--; ) for (w = f; w--; ) this.islandConstraints[w].solve();
                            for (w = f; w--; ) this.islandConstraints[w].postSolve(), (this.islandConstraints[w] = null);
                            var I = 10;
                            for (w = d; w--; )
                                (i = this.islandRigidBodies[w]),
                                    this.callSleep(i)
                                        ? ((i.sleepTime += this.timeStep), i.sleepTime < I && (I = i.sleepTime))
                                        : ((i.sleepTime = 0), (I = 0));
                            if (I > 0.5) for (w = d; w--; ) this.islandRigidBodies[w].sleep(), (this.islandRigidBodies[w] = null);
                            else
                                for (w = d; w--; )
            ...
            add: function (t) {
                var i = (t = t || {}).type || "box";
                return (
                    i.constructor === String && (i = [i]), "joint" === i[0].substring(0, 5) ? this.initJoint(i[0], t) : this.initBody(i, t)
                );
            },
            initBody: function (t, i) {
                ...
                var c = new F();
                void 0 !== i.density && (c.density = i.density),
                    void 0 !== i.friction && (c.friction = i.friction),
                    void 0 !== i.restitution && (c.restitution = i.restitution),
                    void 0 !== i.belongsTo && (c.belongsTo = i.belongsTo),
                    void 0 !== i.collidesWith && (c.collidesWith = i.collidesWith),
                    void 0 !== i.config &&
                        (void 0 !== i.config[0] && (c.density = i.config[0]),
                        void 0 !== i.config[1] && (c.friction = i.config[1]),
                        void 0 !== i.config[2] && (c.restitution = i.config[2]),
                        void 0 !== i.config[3] && (c.belongsTo = i.config[3]),
                        void 0 !== i.config[4] && (c.collidesWith = i.config[4]));
                for (var m, p, u = new ct(new L(a[0], a[1], a[2]), new S().setFromEuler(n[0], n[1], n[2])), y = 0; y < t.length; y++) {
                    switch (
                        (void 0 !== o[(p = 3 * y)] && c.relativePosition.set(o[p], o[p + 1], o[p + 2]),
                        void 0 !== r[p] && c.relativeRotation.setQuat(new S().setFromEuler(r[p], r[p + 1], r[p + 2])),
                        t[y])
                    ) {
                        case "sphere":
                            m = new O(c, l[p]);
                ...
                return (
                    i.neverSleep || e ? (u.allowSleep = !1) : (u.allowSleep = !0),
                    (u.isKinematic = e),
                    h ? (i.massPos || i.massRot ? u.setupMass(1, !1) : u.setupMass(1, !0)) : u.setupMass(2),
                    void 0 !== i.name && (u.name = i.name),
                    this.addRigidBody(u),
                    h && (i.sleep ? u.sleep() : u.awake()),
                    u
                );
            },
            initJoint: function (t, i) {
                ...
                (n = n.map(function (t) {
                    ...
                    "jointDistance" === t
                        ? ((s = i.min || 0), (h = i.max || 10), (s *= e), (h *= e))
                        : ((s = i.min || 57.29578), (h = i.max || 0), (s *= g.degtorad), (h *= g.degtorad));
                var l = i.limit || null,
                    c = i.spring || null,
                    m = i.motor || null,
                    p = new it();
                (p.scale = this.scale),
                    (p.invScale = this.invScale),
                    (p.allowCollision = i.collision || !1),
                    p.localAxis1.set(a[0], a[1], a[2]),
                    p.localAxis2.set(o[0], o[1], o[2]),
                    p.localAnchorPoint1.set(n[0], n[1], n[2]),
                    p.localAnchorPoint2.set(r[0], r[1], r[2]);
                var u,
                    y = null,
                    x = null;
                if (void 0 === i.body1 || void 0 === i.body2) return I("World", "Can't add joint if attach rigidbodys not define !");
                if (
                    (i.body1.constructor === String
                        ? (y = this.getByName(i.body1))
                        : i.body1.constructor === Number
                        ? (y = this.getByName(i.body1))
                        : i.body1.constructor === ct && (y = i.body1),
                    i.body2.constructor === String
                        ? (x = this.getByName(i.body2))
                        : i.body2.constructor === Number
                        ? (x = this.getByName(i.body2))
                        : i.body2.constructor === ct && (x = i.body2),
                    null === y || null === x)
                )
                    return I("World", "Can't add joint attach rigidbodys not find !");
                switch (((p.body1 = y), (p.body2 = x), t)) {
                    case "jointDistance":
                        (u = new Y(p, s, h)),
                            null !== c && u.limitMotor.setSpring(c[0], c[1]),
                            null !== m && u.limitMotor.setMotor(m[0], m[1]);
                        break;
                    case "jointHinge":
                    case "joint":
                        (u = new H(p, s, h)),
                    ...
                    case "jointWheel":
                        (u = new tt(p)),
                            null !== l && u.rotationalLimitMotor1.setLimit(l[0], l[1]),
                            null !== c && u.rotationalLimitMotor1.setSpring(c[0], c[1]),
                            null !== m && u.rotationalLimitMotor1.setMotor(m[0], m[1]);
                }
        ...
        (t.BR_NULL = n),
        (t.BR_BRUTE_FORCE = r),
        (t.BR_SWEEP_AND_PRUNE = l),
        (t.BR_BOUNDING_VOLUME_TREE = c),
        (t.BODY_NULL = m),
        (t.BODY_DYNAMIC = 1),
        (t.BODY_STATIC = 2),
        (t.BODY_KINEMATIC = 3),
